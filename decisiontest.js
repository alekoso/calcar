...
for (const x of ['check.js', 'score.js', 'auction.js']) {
...
(async () => {
  ...
  for (const d of ['i18n/ru.js', 'i18n/en.js']) {
    ...
    for (const k of ['Їхати дивитись', 'Читати повний розбір', 'Перевірити обовʼязково', 'Питання продавцю', 'Чого ми не перевірили']) {
