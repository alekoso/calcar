...
- у "vehicle.premium_options" перелічи ті пункти з vehicle.equipment, які суттєво дорожчі за базові аналоги (матричні/лазерні фари, радари та камери асистентів, адаптивна підвіска, панорама, преміум-аудіо, високовольтна частина). Рядки мають ТОЧНО збігатися з рядками у vehicle.equipment. Якщо таких нема, порожній масив.
- у корені "equipment_impact": дорогі опції цього авто, ЯКІ ЗАЧЕПЛЕНІ ЦИМ УДАРОМ або змінюють вартість чи технологію саме цього ремонту (фара в зоні удару, радар у пошкодженому бампері з обов'язковим калібруванням, датчики в дзеркалі тощо). До кожної: 1 речення, що саме дорожчає і чому, та орієнтовна вартість. Тільки реально дотичне до цього ремонту, не перелік усіх опцій. Якщо удар не зачіпає дорогу комплектацію, порожній масив.

Окремо склади "model_notes": слабкі місця саме цієї моделі/двигуна/покоління. Дві частини:
(а) "issues": типові болячки цього конкретного двигуна, коробки чи покоління, які актуальні при цьому пробігу. Лише те, що дійсно відоме по цій моделі, з прив'язкою до вузла. ЗАБОРОНЕНО вигадувати болячки і писати загальні фрази на кшталт "може бути знос підвіски" чи "перевір рідини". Якщо по цій моделі нічого певного не знаєш, повертай порожній масив. severity: high лише для дорогих або небезпечних вузлів (ланцюг/ремінь ГРМ у приводі, гідроблок АКПП, батарея, турбіна, задирки в блоці), med для відчутних але не критичних, low для дрібниць.
(б) "checklist": 4-7 пунктів, що фізично перевірити перед ставкою або на майданчику, конкретно під цей лот: під ці пошкодження, цю модель, цей пробіг і цю комплектацію (гібридна батарея після удару, калібрування камер і радарів після ремонту бампера, геометрія після структурного удару). Кожен пункт це дія, а не побажання: "заміряти зазори кришки багажника і задніх крил", "перевірити код ГРМ по сервісній історії", "перевірити стан високовольтної батареї сканером". Без "уважно оглянути авто".

Відповідай ЛИШЕ валідним JSON без markdown, без пояснень, точно за схемою:
{
 "vehicle": {"title":"Марка Модель Рік","year":2024,"fuel":"petrol|diesel|hybrid|electric","displacement_l":2.5,"engine":"2.5 л бензин, назва двигуна","transmission":"Автомат, 8 ст.","drive":"Повний AWD","trim":"XLE або null","equipment":["опція 1","опція 2"],"premium_options":["опція 1"],"mileage_note":"пробіг з одометра якщо видно, милі та км"},
 ...
 "equipment_impact":[{"feature":"Матрична фара ліва","detail":"1 коротке речення: що дорожчає і чому","cost":900}],
 "model_notes":{"issues":[{"unit":"Двигун B48","title":"Ланцюг ГРМ","detail":"1-2 короткі речення: у чому проблема, на якому пробігу і як перевірити","severity":"low|med|high","cost":250}],"checklist":["конкретна дія 1","конкретна дія 2"]},
 "reserve":400
}`;
