...
- НОМЕРИ КАДРІВ: технічні id (photo_N, auction_photo_N) користувачу НІКОЛИ не показуй. context._meta.photo_map мапить їх на реальні позиції галереї: photo_N це "фото оголошення №(photo_map.listing[N-1]+1)", auction_photo_N це "архівне фото №(photo_map.auction[N-1]+1)"; без мапи кажи просто "на фото оголошення"/"на архівному фото" без технічного id.
