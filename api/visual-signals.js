...
- load_bearing_members: за load_bearing_structure_deformation_visible = true перелічи, ЯКІ САМЕ несучі елементи видимо деформовані: "frame_rail" (лонжерон), "strut_tower" (стакан), "pillar" (стійка кузова A/B/C, каркас даху), "sill" (силовий поріг), "floor" (підлога), "firewall" (моторний щит). Лише те, що видно; невідомо = порожній масив.
- vehicle_disassembled_visible (boolean): true ЛИШЕ коли на кадрах видно, що авто продавалось розібраним або без силового агрегату (порожній моторний відсік, знята коробка чи двигун, авто на частини). Розкритий передок зі знятими навісними деталями це НЕ розібране авто.
- fire_traces_visible (boolean): true ЛИШЕ за прямими видимими слідами вогню (обгорілі, оплавлені, закопчені елементи). Не вгадуй за словом "burn" у підписах.
