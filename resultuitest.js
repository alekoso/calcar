...
for (const dead of ['.lot-meta{', '.photos{', '.photos .ph', '.verdict-grid', '.v-cell', '.spec-grid', '.v-actions', 'background:#FFF7E8', '#E9C98B', '#8A5A13', '.chip.gold::before']) {
...
if (!/<div class="spec-rows in-body" id="specGrid">/.test(imp)) errs.push('факти комплектації не spec-rows');
