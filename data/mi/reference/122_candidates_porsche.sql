...
select pg_temp.stage('P-001', 'porsche', 'var:m48_02', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-OFF-01'))));

select pg_temp.stage('P-002', 'porsche', 'ver:cayenne_gts_958_1', 'official_fact', 'high',
...
select pg_temp.stage('P-003#a', 'porsche', 'ver:cayenne_gts_958_1', 'official_fact', 'high',
...
select pg_temp.stage('P-003#b', 'porsche', 'var:tr80sd_0c8', 'specialist_practice', 'high',
  'The unit is the Aisin TR-80SD, carried in the group parts system as 0C8.',
  jsonb_build_object(
    'causal', 'unknown',
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-01'))));

select pg_temp.stage('P-004', 'porsche', 'ver:cayenne_gts_958_1', 'official_fact', 'high',
...
select pg_temp.stage('P-005', 'porsche', 'ver:cayenne_gts_958_1', 'official_fact', 'high',
...
select pg_temp.stage('P-006', 'porsche', 'vmy:cayenne_gts_us_2013', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-PRESS-01'), pg_temp.ev('S-P-SPEC-02'))));

select pg_temp.stage('P-007', 'porsche', 'vmy:cayenne_gts_us_2013', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-OFF-02'))));

select pg_temp.stage('P-008', 'porsche', 'vmy:cayenne_gts_us_2013', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-OFF-03'))));

select pg_temp.stage('P-009', 'porsche', 'fam:porsche_m48', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-03'))));

-- ---------- B2. Мотор ----------

select pg_temp.stage('P-020', 'porsche', 'issue:m48_bore_scoring', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-03'),
      pg_temp.ev('S-P-OWN-01', 'thread:rennlist-1274839', '{"mileage_km":240000}'::jsonb),
      pg_temp.ev('S-P-PRESS-02'))));

select pg_temp.stage('P-021', 'porsche', 'issue:958_coolant_pipes', 'known_issue', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      pg_temp.p_date('production_date', date '2011-01-01', date '2018-12-31')),
    'note', 'Ask for proof that the pipes were replaced, and do the job preventively when the water pump comes out.',
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-05'), pg_temp.ev('S-P-SPEC-04'),
      pg_temp.ev('S-P-LEG-01'), pg_temp.ev('S-P-PRESS-02'))));

select pg_temp.stage('P-022', 'porsche', 'issue:958_pump_thermostat', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-04'))));

select pg_temp.stage('P-023', 'porsche', 'issue:958_aos', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-06'),
      pg_temp.ev('S-P-OWN-02', 'thread:planet9-aos', '{"age_years":10}'::jsonb))));

select pg_temp.stage('P-024', 'porsche', 'issue:958_hpfp', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-07'),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-no-records', '{"age_years":11}'::jsonb),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-2013-advice', '{"age_years":11}'::jsonb))));

select pg_temp.stage('P-025#a', 'porsche', 'maint:m48_plugs', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-OFF-04'))));

select pg_temp.stage('P-025#b', 'porsche', 'maint:m48_plugs', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    'layer', 'owner',
    'causal', 'observed_association',
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-02'))));

select pg_temp.stage('P-026#a', 'porsche', 'issue:958_cam_bolts', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OFF-05'), pg_temp.ev('S-P-LEG-02'), pg_temp.ev('S-P-SPEC-08'))));

select pg_temp.stage('P-026#b', 'porsche', 'issue:958_cam_bolts', 'known_issue', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OFF-05'), pg_temp.ev('S-P-SPEC-08'))));

select pg_temp.stage('P-027', 'porsche', 'gen:958_1', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-PRESS-02'))));

select pg_temp.stage('P-028#a', 'porsche', 'var:m48_02', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-06'), pg_temp.ev('S-P-OWN-01'))));

select pg_temp.stage('P-028#b', 'porsche', 'maint:m48_oil', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-06'))));

select pg_temp.stage('P-029', 'porsche', 'issue:958_oil_leaks', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-030#a', 'porsche', 'maint:m48_oil', 'official_fact', 'high',
...
select pg_temp.stage('P-030#b', 'porsche', 'maint:m48_oil', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'causal', 'observed_association',
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-04', 'thread:cayenneforums-intervals', '{"age_years":11}'::jsonb))));

-- ---------- B3. Коробка ----------

select pg_temp.stage('P-040', 'porsche', 'maint:0c8_atf', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-01'), pg_temp.ev('S-P-SPEC-09'))));

select pg_temp.stage('P-041', 'porsche', 'issue:958_valve_body', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-PRESS-02'), pg_temp.ev('S-P-SPEC-09'))));

select pg_temp.stage('P-042', 'porsche', 'var:tr80sd_0c8', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-P-OFF-01'), pg_temp.ev('S-P-SPEC-02'))));

-- ---------- B4. Трансмісія ----------

select pg_temp.stage('P-050#a', 'porsche', 'issue:958_transfer_case', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-LEG-03'), pg_temp.ev('S-P-PRESS-03'))));

select pg_temp.stage('P-050#b', 'porsche', 'issue:958_transfer_case', 'known_issue', 'high',
...
select pg_temp.stage('P-051#a', 'porsche', 'issue:958_transfer_case', 'known_issue', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-10'), pg_temp.ev('S-P-SPEC-11'),
      pg_temp.ev('S-P-OWN-05', 'thread:rennlist-1290994', '{"mileage_km":150000}'::jsonb),
      pg_temp.ev('S-P-OWN-05', 'thread:6speed-tc-replaced', '{"mileage_km":140000}'::jsonb))));

select pg_temp.stage('P-051#b', 'porsche', 'maint:958_tc_fluid', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    'layer', 'specialist',
    'causal', 'supported_cause',
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-10'), pg_temp.ev('S-P-SPEC-11'))));

select pg_temp.stage('P-052#a', 'porsche', 'maint:958_tc_fluid', 'official_fact', 'high',
...
select pg_temp.stage('P-052#b', 'porsche', 'maint:958_tc_fluid', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-11'))));

select pg_temp.stage('P-053#a', 'porsche', 'maint:958_diff_fluid', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-no-records', '{"age_years":11}'::jsonb),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-2013-advice', '{"age_years":11}'::jsonb),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-gts-or-turbo', '{"age_years":11}'::jsonb))));

select pg_temp.stage('P-053#b', 'porsche', 'maint:958_diff_fluid', 'official_fact', 'medium',
  'The official rear differential fluid interval is sixteen years or 160,000 miles.',
  jsonb_build_object(
    'layer', 'official',
    'value_kind', 'interval',
    'value', '{"years":16,"distance":160000,"distance_unit":"mi"}'::jsonb,
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-12'))));

select pg_temp.stage('P-054', 'porsche', 'var:tc_958', 'specialist_practice', 'medium',
  'The clutch of the all wheel drive system is sensitive to different tyres on the two axles.',
  jsonb_build_object(
    'causal', 'supported_cause',
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-10'))));

-- ---------- B5. Шасі ----------

select pg_temp.stage('P-060#a', 'porsche', 'issue:958_air_strut', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-06', 'thread:planet9-249893', '{"mileage_km":200000}'::jsonb),
      pg_temp.ev('S-P-SPEC-13'))));

select pg_temp.stage('P-060#b', 'porsche', 'issue:958_air_strut', 'owner_practice', 'medium',
...
select pg_temp.stage('P-061', 'porsche', 'issue:958_pdcc_lines', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-07', 'thread:planet9-249318', '{"age_years":11}'::jsonb),
      pg_temp.ev('S-P-SPEC-14'))));

select pg_temp.stage('P-062', 'porsche', 'issue:958_pasm_failure', 'owner_pattern', 'low',
  'Damper control failures and damper leaks appear with age and produce a chassis system fault.',
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-02'))));

select pg_temp.stage('P-063#a', 'porsche', 'equip:pccb', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-15'))));

select pg_temp.stage('P-063#b', 'porsche', 'equip:pccb', 'specialist_practice', 'medium',
...
select pg_temp.stage('P-064', 'porsche', 'issue:958_parking_brake', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-P-SPEC-16'))));

-- ---------- B6. Електроніка і кузов ----------

select pg_temp.stage('P-070', 'porsche', 'issue:958_pcm_faults', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-08', 'thread:planet9-pcm'),
      pg_temp.ev('S-P-OWN-08', 'thread:rennlist-seat-memory'))));

select pg_temp.stage('P-071', 'porsche', 'issue:958_weak_battery', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-072', 'porsche', 'maint:958_drains', 'owner_practice', 'medium',
...
select pg_temp.stage('P-073', 'porsche', 'issue:958_brittle_plastic', 'owner_pattern', 'high',
...
select pg_temp.stage('P-080', 'porsche', 'ver:cayenne_gts_958_1', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-09', 'thread:fuelly-gts'),
      pg_temp.ev('S-P-OWN-09', 'thread:pistonheads-mpg'),
      pg_temp.ev('S-P-OWN-09', 'thread:rennlist-mileage'))));

select pg_temp.stage('P-081', 'porsche', 'ver:cayenne_gts_958_1', 'calcar_synthesis', 'high',
...
select pg_temp.stage('P-082', 'porsche', 'ver:cayenne_gts_958_1', 'owner_practice', 'high',
  ...
  jsonb_build_object(
    'causal', 'observed_association',
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-02'),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-no-records', '{"age_years":11}'::jsonb),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-2013-advice', '{"age_years":11}'::jsonb),
      pg_temp.ev('S-P-OWN-03', 'thread:rennlist-gts-or-turbo', '{"age_years":11}'::jsonb))));

select pg_temp.stage('P-083', 'porsche', 'ver:cayenne_gts_958_1', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-10', 'thread:rennlist-turbo-vs-gts'),
      pg_temp.ev('S-P-OWN-10', 'thread:6speed-gts-turbo'))));

select pg_temp.stage('P-084#a', 'porsche', 'ver:cayenne_gts_958_1', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-P-PRESS-04'))));

select pg_temp.stage('P-084#b', 'porsche', 'ver:cayenne_gts_958_1', 'owner_pattern', 'high',
  'Owners who have driven both the 2013 and the 2014 car report no difference in power delivery between them.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-OWN-11', 'thread:rennlist-2013-vs-2014'),
      pg_temp.ev('S-P-OWN-11', 'thread:rennlist-958-1-or-958-2'))));
