...
insert into mi.version_market_year (subject_id, version_id, market_code, model_year,
  ...
  (pg_temp.mk('vmy:530ix_us_2017', 'version_market_year', 'BMW 530i xDrive US MY2017'),
   pg_temp.sid('ver:530ix_g30'), 'US', 2017,
   date '2016-10-11', 'known', date '9999-12-31', 'unknown', null, null),
  (pg_temp.mk('vmy:530ix_us_2018', 'version_market_year', 'BMW 530i xDrive US MY2018'),
   pg_temp.sid('ver:530ix_g30'), 'US', 2018,
   date '2017-07-01', 'known', date '9999-12-31', 'unknown', 54700.00, 'USD'),
  (pg_temp.mk('vmy:530ix_us_2019', 'version_market_year', 'BMW 530i xDrive US MY2019'),
   pg_temp.sid('ver:530ix_g30'), 'US', 2019,
...
insert into mi.component_family (subject_id, brand_id, family_key, family_kind_code, architecture_en) values
  (pg_temp.mk('fam:b48', 'component_family', 'BMW B48 inline four'), pg_temp.sid('brand:bmw'),
   'BMW_B48', 'engine',
...
insert into mi.component_variant (subject_id, family_id, variant_code, name_en,
  ...
  (pg_temp.mk('var:b48b20o0', 'component_variant', 'BMW B48B20O0'), pg_temp.sid('fam:b48'),
   'B48B20O0', 'B48 high output, first revision', null,
   date '0001-01-01', 'unknown', date '9999-12-31', 'unknown');

insert into mi.component_variant (subject_id, family_id, variant_code, name_en,
    revision_of_id, prod_from, prod_from_kind, prod_to, prod_to_kind) values
  (pg_temp.mk('var:b46b20o0', 'component_variant', 'BMW B46B20O0 (SULEV B48)'), pg_temp.sid('fam:b48'),
   'B46B20O0', 'B46 SULEV variant of the B48B20O0 for North America', null,
   date '0001-01-01', 'unknown', date '9999-12-31', 'unknown'),
  (pg_temp.mk('var:b48b20o1', 'component_variant', 'BMW B48B20O1 (B48TU)'), pg_temp.sid('fam:b48'),
   'B48B20O1', 'B48 technical update: 350 bar injection, one-piece timing chain, split cooling circuits',
   pg_temp.sid('var:b48b20o0'),
   date '0001-01-01', 'unknown', date '9999-12-31', 'unknown');
...
insert into mi.variant_attribute (variant_id, attr_key, attr_value) values
  (pg_temp.sid('var:b48b20o0'), 'injection_pressure_bar', '200'),
  (pg_temp.sid('var:b46b20o0'), 'injection_pressure_bar', '200'),
  (pg_temp.sid('var:b48b20o1'), 'injection_pressure_bar', '350'),
  (pg_temp.sid('var:b48b20o0'), 'performance_division', 'series'),
  (pg_temp.sid('var:b46b20o0'), 'performance_division', 'series'),
  (pg_temp.sid('var:b48b20o1'), 'performance_division', 'series');

-- ---------- ZF 8HP50 у наявній родині ZF 8HP ----------

insert into mi.component_variant (subject_id, family_id, variant_code, name_en,
    prod_from, prod_from_kind, prod_to, prod_to_kind) values
  (pg_temp.mk('var:zf8hp50', 'component_variant', 'ZF 8HP50 (GA8HP50Z)'), pg_temp.sid('fam:zf8hp'),
...
insert into mi.version_fitment (vmy_id, role_code, variant_id, fitment) values
  (pg_temp.sid('vmy:530ix_us_2017'), 'engine',        pg_temp.sid('var:b46b20o0'), 'standard'),
  (pg_temp.sid('vmy:530ix_us_2017'), 'transmission',  pg_temp.sid('var:zf8hp50'),  'standard'),
  (pg_temp.sid('vmy:530ix_us_2017'), 'transfer_case', pg_temp.sid('var:atc13_1'),  'standard'),
  (pg_temp.sid('vmy:530ix_us_2018'), 'engine',        pg_temp.sid('var:b46b20o0'), 'standard'),
  (pg_temp.sid('vmy:530ix_us_2018'), 'transmission',  pg_temp.sid('var:zf8hp50'),  'standard'),
  (pg_temp.sid('vmy:530ix_us_2018'), 'transfer_case', pg_temp.sid('var:atc13_1'),  'standard'),
  (pg_temp.sid('vmy:530ix_us_2019'), 'engine',        pg_temp.sid('var:b46b20o0'), 'standard'),
  (pg_temp.sid('vmy:530ix_us_2019'), 'transmission',  pg_temp.sid('var:zf8hp50'),  'standard'),
...
insert into mi.subject_alias (target_subject_id, alias, alias_norm, lang, alias_kind, scope_kind, scope_subject_id) values
  ...
  (pg_temp.sid('ver:530ix_g30'), '530xi',       '530xi',       'en', 'community', 'generation', pg_temp.sid('gen:g30')),
  (pg_temp.sid('var:b46b20o0'),  'B46',         'b46',         'en', 'community', 'brand', pg_temp.sid('brand:bmw')),
  (pg_temp.sid('var:b48b20o1'),  'B48TU',       'b48tu',       'en', 'community', 'brand', pg_temp.sid('brand:bmw')),
  (pg_temp.sid('var:zf8hp50'),   'GA8HP50Z',    'ga8hp50z',    'en', 'official',  'global', null);

-- ---------- Проблеми ----------

insert into mi.issue (subject_id, issue_key, about_subject_id, name_en, mechanism_en, severity, sensitivity) values
  (pg_temp.mk('issue:b48_oil_filter_housing', 'issue', 'B46/B48 oil filter housing coolant leak'),
   'bmw_b48_oil_filter_housing_leak', pg_temp.sid('fam:b48'),
   ...
   'major', 'calendar'),
  (pg_temp.mk('issue:b46_turbo_coolant_lines', 'issue', 'B46 G30 turbocharger coolant lines leak'),
   'bmw_b46_g30_turbo_coolant_lines', pg_temp.sid('var:b46b20o0'),
  ...
  (pg_temp.mk('issue:g30_expansion_tank', 'issue', 'G30 B46/B48 coolant expansion tank and vent hose'),
   'bmw_g30_b48_expansion_tank_vent', pg_temp.sid('fam:b48'),
   ...
   'moderate', 'calendar'),
  (pg_temp.mk('issue:b48_water_pump', 'issue', 'B48 mechanical coolant pump leak'),
   'bmw_b48_coolant_pump_leak', pg_temp.sid('fam:b48'),
   ...
   'major', 'mileage'),
  (pg_temp.mk('issue:b48_head_vent_line', 'issue', 'B46/B48 cylinder head coolant vent line'),
   'bmw_b48_cylinder_head_vent_line', pg_temp.sid('fam:b48'),
   ...
   'major', 'calendar'),
  (pg_temp.mk('issue:b48_pcv_diaphragm', 'issue', 'B46/B48 valve cover PCV diaphragm'),
   'bmw_b48_pcv_diaphragm', pg_temp.sid('fam:b48'),
   ...
   'moderate', 'mileage'),
  (pg_temp.mk('issue:b48_charge_pipe', 'issue', 'B46/B48 plastic charge pipe'),
   'bmw_b48_charge_pipe', pg_temp.sid('fam:b48'),
   'Plastic charge pipe or coupler cracks under boost', null,
   'moderate', 'mixed'),
  (pg_temp.mk('issue:b48_belt_tensioner', 'issue', 'B46/B48 belt tensioner rattle'),
   'bmw_b48_belt_tensioner', pg_temp.sid('fam:b48'),
   'Accessory belt tensioner rattles at idle', null,
   'minor', 'mileage'),
  (pg_temp.mk('issue:b48_intake_carbon', 'issue', 'B48 intake valve carbon build-up'),
   'bmw_b48_intake_valve_carbon', pg_temp.sid('fam:b48'),
   ...
   'minor', 'mileage'),
  (pg_temp.mk('issue:b48_timing_chain', 'issue', 'B48 timing chain wear'),
   'bmw_b48_timing_chain', pg_temp.sid('fam:b48'),
   'Timing chain, guides or tensioner wear', null,
   'major', 'usage'),
  (pg_temp.mk('issue:b46_hpfp', 'issue', 'B46 high pressure fuel pump'),
   'bmw_b46_high_pressure_fuel_pump', pg_temp.sid('var:b46b20o0'),
   'High pressure fuel pump failure', null,
   'major', 'mileage'),
  (pg_temp.mk('issue:g30_seat_mat', 'issue', 'G30 passenger seat occupancy sensor'),
   'bmw_g30_passenger_seat_occupancy_mat', pg_temp.sid('gen:g30'),
   ...
   'moderate', 'calendar'),
  (pg_temp.mk('issue:g30_nbt_evo_hdd', 'issue', 'G30 iDrive 6 head unit storage'),
   'bmw_g30_nbt_evo_head_unit', pg_temp.sid('gen:g30'),
   'iDrive 6 head unit navigation and media fail with a storage fault', null,
   'moderate', 'calendar'),
  (pg_temp.mk('issue:g30_air_flaps', 'issue', 'G30 active radiator air flaps'),
   'bmw_g30_active_air_flaps', pg_temp.sid('gen:g30'),
...
insert into mi.maintenance_item (subject_id, about_subject_id, service_kind_code, fluid_spec_code, capacity_note_en) values
  (pg_temp.mk('maint:b46_oil', 'maintenance_item', 'B46B20O0 engine oil and filter'),
   pg_temp.sid('var:b46b20o0'), 'engine_oil', null,
   'BMW Longlife-17 FE+ (earlier Longlife-14 FE+) 0W-20; about 5.25 litres with filter, later ISTA revisions quote 5.75'),
  (pg_temp.mk('maint:b46_plugs', 'maintenance_item', 'B46B20O0 spark plugs'),
   pg_temp.sid('var:b46b20o0'), 'spark_plugs', null, null),
  (pg_temp.mk('maint:zf8hp50_atf', 'maintenance_item', 'ZF 8HP50 transmission fluid'),
   pg_temp.sid('var:zf8hp50'), 'atf', 'ZF_LIFEGUARD_8',
...
insert into mi.check_item (subject_id, test_method_code, scope_subject_id, why_en, proves_en,
  ...
  (pg_temp.mk('chk:b48_cooling_inspection', 'check_item', 'B46/B48 cooling system inspection under the intake'),
   'visual', pg_temp.sid('fam:b48'),
   ...
   'must', false, null),
  (pg_temp.mk('chk:g30_xdrive_road_test', 'check_item', 'xDrive low speed turning road test'),
   'road_test', pg_temp.sid('var:atc13_1'),
   ...
   'good', false, null),
  (pg_temp.mk('chk:530i_recall_lookup', 'check_item', 'Recall completion check by VIN'),
   'documentation', pg_temp.sid('ver:530ix_g30'),
...
insert into mi.check_covers (check_id, target_subject_id, role) values
  (pg_temp.sid('chk:b48_cooling_inspection'),  pg_temp.sid('issue:b48_oil_filter_housing'), 'detects'),
  (pg_temp.sid('chk:b48_cooling_inspection'),  pg_temp.sid('issue:b46_turbo_coolant_lines'), 'detects'),
  (pg_temp.sid('chk:b48_cooling_inspection'),  pg_temp.sid('issue:g30_expansion_tank'), 'detects'),
  (pg_temp.sid('chk:b48_cooling_inspection'),  pg_temp.sid('issue:b48_water_pump'), 'detects'),
  (pg_temp.sid('chk:b48_cooling_inspection'),  pg_temp.sid('issue:b48_head_vent_line'), 'detects'),
  (pg_temp.sid('chk:g30_xdrive_road_test'),    pg_temp.sid('issue:g30_xdrive_shudder'), 'detects'),
  ...
  (pg_temp.sid('chk:g30_ista_scan'),           pg_temp.sid('issue:b48_pcv_diaphragm'), 'detects');
...
insert into mi.component_state_type (subject_id, state_key, state_kind, applies_to_subject_id,
  ...
  (pg_temp.mk('state:b48_ofh_aluminium', 'component_state_type', 'B46/B48 oil filter housing replaced with an aluminium unit'),
   'bmw_b48_ofh_aluminium_replacement', 'retrofit', pg_temp.sid('fam:b48'), null, false);
