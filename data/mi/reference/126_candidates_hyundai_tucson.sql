...
select pg_temp.stage('H-001', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-01', null, null, 'supports', '2018 Tucson FWD: displ 2.4, Automatic (S6), Front-Wheel Drive, SIDI.'),
      pg_temp.ev('S-H-OFF-02', null, null, 'supports', '2018 Tucson AWD: Auto (S6), 4 cyl, 2.4 L.'),
      pg_temp.ev('S-H-OFF-03', null, null, 'supports', '2019 Tucson FWD: Auto (S6), 4 cyl, 2.4 L.'),
      pg_temp.ev('S-H-OFF-04', null, null, 'supports', '2019 Tucson AWD: displ 2.4, Automatic (S6), All-Wheel Drive, SIDI.'),
      pg_temp.ev('S-H-OFF-05', null, null, 'supports', '2020 Tucson FWD: Auto (S6), 4 cyl, 2.4 L.'),
      pg_temp.ev('S-H-OFF-06', null, null, 'supports', '2020 Tucson AWD: Auto (S6), 4 cyl, 2.4 L.'),
      pg_temp.ev('S-H-OFF-07', null, null, 'supports', '2021 Tucson FWD: Auto (S6), 4 cyl, 2.4 L.'),
      pg_temp.ev('S-H-OFF-08', null, null, 'supports', '2021 Tucson AWD: Auto (S6), 4 cyl, 2.4 L.'),
      pg_temp.ev('S-H-OFF-09', null, null, 'context', '2022 Tucson FWD: Auto (S8), 4 cyl, 2.5 L as the only entry.'))));

select pg_temp.stage('H-002', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-12', null, null, 'supports', '2018 TUCSON Specifications. ENGINE SE/SEL/SEL Plus Type 2.0L DOHC ... Value/Limited Type 1.6L Turbo-GDI.'),
      pg_temp.ev('S-H-OFF-01', null, null, 'supports', 'year 2018, model Tucson FWD, displ 2.4, createdOn 2017-11-10.'),
      pg_temp.ev('S-H-OWN-01', 'odi:11695832', '{"age_years":7}'::jsonb, 'context', 'VIN KM8J33AL9JU: eighth character L, tenth character J for model year 2018.'))));

select pg_temp.stage('H-003', 'tucson_tl_24', 'var:theta2_24_gdi', 'official_fact', 'high',
...
select pg_temp.stage('H-004', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-10', null, null, 'supports', 'KM8J33AL: 2.4, GDI Theta II, 4x2. KM8J3CAL: 2.4, GDI Theta II, 4WD/4-Wheel Drive/4x4. KM8J33A4: 2, GDI Nu, 4x2. KM8J3CA4: 2, GDI Nu, 4WD. KM8J33A2: 1.6, T-GDI GAMMA, 4x2. Plant country SOUTH KOREA.'))));

-- ---------- H2. Гарантія і покриття ----------

select pg_temp.stage('H-010', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-14', null, null, 'supports', 'Coverage applies to original owner only, effective with 2004 model year and newer model-year vehicles. Second and/or subsequent owners have powertrain components coverage under the 5-Year/60,000-Mile New Vehicle Limited Warranty. Excludes coverage for vehicles in commercial use.'))));

select pg_temp.stage('H-011', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'high',
...
select pg_temp.stage('H-012', 'tucson_tl_24', 'ent:tucson_theta_ext', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      pg_temp.p_ref('version', 'ver:tucson24', 1),
      pg_temp.p_num('model_year', 2018, 2019, 2),
      pg_temp.p_ref('entitlement_state', 'ent:tucson_theta_ext', 3)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-18', null, null, 'supports', 'The warranty coverage for engine long block repair or replacement regarding engine damage or malfunction from connecting rod bearing wear has been extended to 10 years or 120,000 miles from the date of original retail delivery or date of first use, whichever occurs first. Warranty coverage is valid for original and subsequent owners. Certain 2018-2019 MY Tucson (TL) vehicles with Theta II 2.4L GDI engines.'),
      pg_temp.ev('S-H-OFF-17', null, null, 'supports', 'The T3G Service Procedure TSB (# 22-01-033H or latest) Flowchart has been revised to remove KSDS prerequisite (Service Campaign 953) and includes conditions of Check Engine warning lamp illuminated with DTC P1326 and/or abnormal noise or no crank/no start condition related to connecting rod bearing wear or damage.'),
      pg_temp.ev('S-H-OFF-20', null, null, 'context', 'TSB 21-01-002H, 2.4L / 2.0L Turbo engine warranty extension (TXXC): Certain 2018-2019 MY Tucson (TL) vehicles with 2.4L engines.'))));

select pg_temp.stage('H-013', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_num('model_year', 2020, 2021, 1)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-17', null, null, 'supports', 'Applicable vehicles T3G, TXXC and TXXI: Certain 2014-2015 MY Tucson (LM) vehicles with Theta II 2.4L GDI engines; Certain 2018-2019 MY Tucson (TL) vehicles with Theta II 2.4L GDI engines.'),
      pg_temp.ev('S-H-OFF-23', null, null, 'supports', 'TXXM/T6G Applicable Vehicles: Certain 2016-2021 MY Tucson (TL) vehicles with Nu 2.0L GDI engines.'),
      pg_temp.ev('S-H-OFF-22', null, null, 'supports', 'TSB 22-01-023H-1: Adding 2019-21MY Tucson (TL) ... Special Exception Cases: 2019-21MY Tucson (TL) 2.0L.'),
      pg_temp.ev('S-H-OFF-24', null, null, 'context', 'After installation of the KSDS update (Service Campaign 966), the Powertrain Limited Warranty coverage ... will be extended by Hyundai to 15 years or 150,000 miles ... salvaged vehicles are ineligible.'))));

select pg_temp.stage('H-014', 'tucson_tl_24', 'ent:tucson_theta_ext', 'official_fact', 'high',
...
select pg_temp.stage('H-020', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'known_issue', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-17', null, null, 'supports', 'Certain vehicles with 2.0L T-GDI and 2.4L GDI engines may experience the Check Engine warning lamp illuminated with DTC P1326 and/or engine may exhibit abnormal noise or no crank/no start condition related to connecting rod bearing wear or damage. Warranty Extension: coverage for engine long block repair or replacement regarding engine damage or malfunction from connecting rod bearing wear has been extended under TXXC & TXXI.'),
      pg_temp.ev('S-H-OFF-15', null, null, 'supports', 'Dealers must perform Service Campaign T3G on all vehicles that return with DTC P132600 ... Certain 2018-2019 MY Tucson (TL) vehicles with 2.4L engines.'),
      pg_temp.ev('S-H-OFF-18', null, null, 'supports', 'Certain 2018-2019 MY Tucson (TL) vehicles with Theta II 2.4L GDI engines: engine long block ... connecting rod bearing wear.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11710997', '{"age_years":5}'::jsonb, 'supports', '2020 Tucson, VIN KM8J3CAL8LU: the engine suddenly lost power and the vehicle entered limp mode ... diagnostic code P1326 was later confirmed, indicating engine bearing failure ... pending a full engine replacement.'),
      pg_temp.ev('S-H-OWN-04', 'odi:11608558', '{"age_years":3}'::jsonb, 'supports', '2021 Tucson, VIN KM8J33AL8MU: the code 1326 came up. I was told it is a rod bearing engine failure and I need a new engine ... my vehicle does not qualify for the recall already made for this damage and code number.'))));

select pg_temp.stage('H-021', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'owner_pattern', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_num('model_year', 2020, 2021, 1)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-04', 'odi:11608558', '{"age_years":3}'::jsonb, 'supports', '2021 Tucson 2.4: code 1326, rod bearing engine failure, needs a new engine, does not qualify for the recall.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11710997', '{"age_years":5}'::jsonb, 'supports', '2020 Tucson 2.4: limp mode, P1326 confirmed, engine bearing failure, pending full engine replacement.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11741423', '{"age_years":6}'::jsonb, 'supports', '2020 Tucson 2.4: loud knocking/rattling noise and the check engine light began flashing ... The engine requires replacement. Hyundai denied coverage, claiming excessive oil consumption and/or maintenance concerns.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11680074', '{"mileage_km":134380}'::jsonb, 'supports', '2020 Tucson 2.4: abnormally loud knocking sound coming from the vehicle before the engine seized. The failure mileage was approximately 83,500.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11519312', '{"mileage_km":127756}'::jsonb, 'supports', '2020 Tucson 2.4: engine decelerated, oil pressure light, not able to accelerate past 50 mph, engine starting knocking. Car has 79,384 miles. Dealership states engine failure and that engine needs to be replaced.'),
      pg_temp.ev('S-H-OWN-04', 'odi:11531301', '{"mileage_km":38624}'::jsonb, 'supports', '2021 Tucson 2.4: suddenly stuttered and decelerated ... only has 24K miles ... they told me it needed a new engine, but the service department needed approval from corporate Hyundai.'),
      pg_temp.ev('S-H-OWN-04', 'odi:11760640', '{"age_years":5}'::jsonb, 'supports', '2021 Tucson 2.4: Engine knock sensor went off and now the engine needs replacement due to faulty cylinder rod.'))));

select pg_temp.stage('H-022', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_num('model_year', 2019, 2019, 1)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-02', 'odi:11760673', '{"age_years":7}'::jsonb, 'supports', '2019 Tucson 2.4: my car experienced sudden knocking in the engine ... Problem is the theta 2 engine and though the car is under extended warranty Hyundai is requesting maintenance records before repairing this.'),
      pg_temp.ev('S-H-OWN-02', 'odi:11666175', '{"age_years":6}'::jsonb, 'supports', '2019 Tucson 2.4: The engine seized while on the highway unexpectedly ... the car stalled.'),
      pg_temp.ev('S-H-OWN-02', 'odi:11719540', '{"age_years":7}'::jsonb, 'supports', '2019 Tucson 2.4: Low oil, burnt oil on dip stick, engine running dangerous hot, lights on on dash, engine knocking.'))));

select pg_temp.stage('H-023', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-17', null, null, 'supports', 'Please refer to TSB #21-EM-004H-1 (or latest version) for the service procedure for engine connecting rod bearing clearance testing ... Bearing Tool SST Power Check ... If a vehicle is brought in for an engine condition unrelated to T3G (e.g. oil consumption), please follow the proper engine diagnosis procedures, and refer to standard warranty policies and procedures.'),
      pg_temp.ev('S-H-OFF-16', null, null, 'context', 'For replacements or questions on the bearing tool, please contact GIT.'))));

select pg_temp.stage('H-024', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-30', null, null, 'supports', 'Model Year 2013 through 2014 Hyundai Sonata sedans produced at Hyundai Motor Manufacturing Alabama ... 2013 through 2014 Hyundai Santa Fe Sport vehicles produced at Kia Motor Manufacturing Georgia ... The subject engines may contain residual debris from factory machining operations, potentially restricting oil flow to the main bearings and leading to premature bearing wear.'),
      pg_temp.ev('S-H-OFF-31', null, null, 'supports', 'If the debris is not completely removed from the crankshaft oil passages, it can be forced into the connecting rod oiling passages restricting oil flow to the bearings ... A worn connecting rod bearing will produce a metallic, cyclic knocking noise from the engine which increases in frequency as the engine rpm increases.'),
      pg_temp.ev('S-H-OFF-27', null, null, 'supports', 'Certain Model Year 2019 Hyundai Tucson vehicles produced ... by Hyundai Motor Company (HMC) in South Korea for sale in the U.S. market.'))));

select pg_temp.stage('H-025', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-02', 'odi:11634976', '{"age_years":6}'::jsonb, 'supports', 'Engine failure will be caused by shrapnel in the engine (Dealer told me Hyundai is aware it was not vacuumed out properly in this particular batch of engines) leading to ruts being warn in the cylinder causing oil to leak past piston rings.'))));

-- ---------- H4. KSDS ----------

select pg_temp.stage('H-030', 'tucson_tl_24', 'state:theta24_ksds', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-21', null, null, 'supports', 'Hyundai has developed new engine monitoring technology called a knock sensor detection system. The technology enables the detection of potential early engine issues caused by excessive bearing wear. The technology will be installed free of charge on ... 2014-15 and 18-19 Tucson.'),
      pg_temp.ev('S-H-OFF-15', null, null, 'supports', 'Dealers must perform Service Campaign T3G on all vehicles that return with DTC P132600.'),
      pg_temp.ev('S-H-OFF-26', null, null, 'supports', 'Kia has developed a Knock Sensor Detection System (KSDS) that detects vibrations indicating the onset of excessive connecting rod bearing wear ... the Malfunction Indicator Lamp (MIL) will blink continuously, and the vehicle will be placed in Limp Home Mode. This will reduce further damage.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11710997', '{"age_years":5}'::jsonb, 'context', '2020 Tucson 2.4: entered limp mode, P1326 confirmed, engine bearing failure.'))));

select pg_temp.stage('H-031', 'tucson_tl_24', 'ver:tucson24', 'official_fact', 'low',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_num('model_year', 2020, 2021, 1)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-04', 'odi:11735611', '{"mileage_km":144841}'::jsonb, 'supports', '2021 Tucson 2.4: repeated knock sensor (P1326) fault that causes the vehicle to enter limp mode ... at approximately 15,000, 17,000, 41,000, and 90,000 miles ... an ECM update and three knock sensor replacements.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11710997', '{"age_years":5}'::jsonb, 'supports', '2020 Tucson 2.4: limp mode and P1326.'),
      pg_temp.ev('S-H-AGG-01', null, null, 'contradicts', 'Aggregator summary: the Knock Sensor Detection System was added via a software update (Service Campaign 966) and is not a standard factory feature in the 2020 Tucson.'))));

-- ---------- H5. Заміна мотора ----------

select pg_temp.stage('H-040', 'tucson_tl_24', 'state:theta24_long_block', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-15', null, null, 'supports', 'For 2019MY vehicles that require an engine replacement, a reman must be used. If a reman is not available, make sure to print out a screenshot of parts availability screen showing reman not available and attach when submitting the claim.'),
      pg_temp.ev('S-H-OFF-16', null, null, 'supports', 'Make sure to reference HMA Warranty Policy prior to ordering a reman engine. A standard service engine or QQH engine is required in certain cases.'),
      pg_temp.ev('S-H-OFF-17', null, null, 'context', 'Please refer to TSB 22-01-034H (or latest version) for applicable part numbers and labor ops.'))));

select pg_temp.stage('H-041', 'tucson_tl_24', 'ent:tucson_theta_ext', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      ...
      pg_temp.p_ref('entitlement_state', 'ent:tucson_theta_ext', 3)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-LEG-01', 'doc:theta-settlement', null, 'supports', 'equipped with or replaced with a genuine Theta II 2.0 liter or 2.4 liter gasoline direct injection engine within OEM specifications ... the Limited Warranty shall otherwise endure for bearing wear or damage irrespective of ... prior warranty engine repairs and/or warranty replacements.'),
      pg_temp.ev('S-H-LEG-02', 'doc:theta-settlement', null, 'supports', 'Claimant is a Class member or other person or entity eligible to make a Claim pursuant to this Settlement Agreement (e.g., a subsequent purchaser of a Class Vehicle under the terms of the Lifetime Warranty).'))));

-- ---------- H6. Олива ----------

select pg_temp.stage('H-050', 'tucson_tl_24', 'issue:theta24_oil_consumption', 'owner_pattern', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-03', 'odi:11747239', '{"mileage_km":80467}'::jsonb, 'supports', '2020 Tucson 2.4 Theta II GDI, purchased new and maintained properly. Excessive oil consumption began at about 50,000 miles ... An oil consumption test was done at the Hyundai dealer. Conclusion ... it is not bad enough to remedy.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11742588', '{"mileage_km":82077}'::jsonb, 'supports', '2020 Tucson: the car has about 51,000 miles ... they confirmed the engine was consuming oil ... the next step in the process is a combustion chamber cleaning.'),
      pg_temp.ev('S-H-OWN-04', 'odi:11752252', '{"mileage_km":114263}'::jsonb, 'supports', '2021 Tucson 2.4: burns oil at an alarming rate ... when I take it in, the dipstick is dry. I receive no oil lights to tell me it is low ... I am at 71,000 miles.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11711727', '{"age_years":4}'::jsonb, 'supports', '2020 Tucson 2.4: burning oil for about two years ... I have had to add oil every 1000 miles.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11677069', '{"age_years":5}'::jsonb, 'supports', '2020 Tucson 2.4: Engine is consuming 3+ quarts per 1000 miles. There is no low oil warning light or notification, just a low oil pressure light.'),
      pg_temp.ev('S-H-OWN-01', 'odi:11689224', '{"age_years":7}'::jsonb, 'supports', '2018 Tucson 2.4: after four consumption tests ... the engine is burning between 0.8 and 0.3 liters of oil for every 1,000.'))));

select pg_temp.stage('H-051', 'tucson_tl_24', 'issue:theta24_oil_consumption', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-25', null, null, 'supports', 'Launch of Engine Oil Consumption Inspection and Repair Guidelines (TSB #23-EM-008H); Launch of Combustion Chamber Cleaning Procedure (TSB #23-EM-007H) 12/11/2023 ... The latest combustion chamber cleaning procedure is currently applicable to 4-cylinder engines ... for all Hyundai models and model year vehicles equipped with gasoline engines.'),
      pg_temp.ev('S-H-OFF-17', null, null, 'supports', 'If a vehicle is brought in for an engine condition unrelated to T3G (e.g. oil consumption), please follow the proper engine diagnosis procedures, and refer to standard warranty policies and procedures.'))));

select pg_temp.stage('H-052', 'tucson_tl_24', 'issue:theta24_rod_bearing', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-03', 'odi:11519312', '{"mileage_km":127756}'::jsonb, 'supports', 'Car has 79,384 miles on it. Dealership states engine failure and that engine needs to be replaced. Car had burned up almost all the oil that had been replaced two months prior.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11721101', '{"age_years":5}'::jsonb, 'supports', 'Complete engine failure. Car was burning oil ... the engine oil light keeps coming on when rounding bends or stopping on a hill ... oil is half gone in between oil changes. The car stalled.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11751269', '{"age_years":6}'::jsonb, 'supports', 'The check engine light started flashing and so did the oil light. Read the code as cylinder 3 misfire and a knock sensor ... checked the oil and saw there was no oil in the engine.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11644900', '{"age_years":5}'::jsonb, 'supports', '2020 Hyundai Tucson engine continually consumes an excess amount of oil on a weekly basis causing cylinder knocks.'))));

select pg_temp.stage('H-053', 'tucson_tl_24', 'ver:tucson24', 'owner_pattern', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OWN-03', 'odi:11741423', '{"age_years":6}'::jsonb, 'supports', 'Hyundai denied coverage, claiming excessive oil consumption and/or maintenance concerns. However, upon inspection, the dealership removed the valve cover and advised that the engine was internally clean.'),
      pg_temp.ev('S-H-OWN-03', 'odi:11742588', '{"mileage_km":82077}'::jsonb, 'supports', 'We were able to find evidence of 5 oil changes ... the combustion chamber cleaning which costs $1400 which would normally be covered by warranty but since we did not have all records of oil changes they will not cover it.'),
      pg_temp.ev('S-H-OWN-02', 'odi:11760673', '{"age_years":7}'::jsonb, 'supports', 'Though the car is under extended warranty Hyundai is requesting maintenance records before repairing this.'),
      pg_temp.ev('S-H-OWN-02', 'odi:11634976', '{"age_years":6}'::jsonb, 'supports', 'Extended warranty may deny due to 3 missed air filter changes.'),
      pg_temp.ev('S-H-LEG-01', 'doc:theta-settlement', null, 'context', 'Class members are suggested to retain all vehicle maintenance records. With the exception of cases of exceptional neglect.'),
      pg_temp.ev('S-H-LEG-02', 'doc:theta-settlement', null, 'context', 'Exceptional Neglect means when the vehicle clearly evidences a lack of maintenance or care for a significant period of time of not less than one (1) year, such that the vehicle appears dilapidated, abandoned, and/or beyond repair.'))));

-- ---------- H7. Обслуговування і повний привід ----------

select pg_temp.stage('H-060', 'tucson_tl_24', 'maint:theta24_oil', 'official_fact', 'medium',
...
select pg_temp.stage('H-061', 'tucson_tl_24', 'maint:theta24_plugs', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-13', null, null, 'supports', 'Spark plugs: Replace every 97,500 miles. Severe usage: Spark plugs R More frequently.'))));

select pg_temp.stage('H-062', 'tucson_tl_24', 'maint:theta24_coolant', 'official_fact', 'medium',
...
select pg_temp.stage('H-063', 'tucson_tl_24', 'maint:tl24_atf', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-13', null, null, 'supports', 'Automatic transmission fluid: No check, No service required. Severe usage: Automatic transmission fluid R Every 60,000 miles. Automatic transmission fluid 2.4 GDI 2WD 7.08 US qt. (6.7 l) AWD 7.08 US qt. (6.7 l) ATF SP-IV.'))));

select pg_temp.stage('H-064#a', 'tucson_tl_24', 'maint:tl_awd_transfer', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-13', null, null, 'supports', 'Transfer case oil (AWD) I. Transfer case oil and rear differential oil should be changed anytime they have been submerged in water.'))));

select pg_temp.stage('H-064#b', 'tucson_tl_24', 'maint:tl_awd_diff', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'value_kind', 'document_ref',
    'value', '{"manual":"2020 Tucson Owners Manual","schedule":"inspect","change_when":"submerged in water"}'::jsonb,
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-13', null, null, 'supports', 'Rear differential oil (AWD) I. Transfer case oil and rear differential oil should be changed anytime they have been submerged in water.'))));

select pg_temp.stage('H-065', 'tucson_tl_24', 'eq:tucson_awd', 'official_fact', 'high',
...
select pg_temp.stage('H-070', 'tucson_tl_24', 'var:tucson24_6at', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-33', null, null, 'supports', 'Automatic transmission stall test procedure ... PASS: Stall speed is between 1700~2900 rpm ... If the vehicle fails the stall test, replace the transmission. Tucson (TL) 2.4L. Warranty Information: Normal warranty applies.'),
      pg_temp.ev('S-H-OFF-34', null, null, 'supports', 'Automatic transmission incorrect ratio DTC P0731, P0732, P0733, P0734, P0735, P0736, P0729, P076F & P0730 ... procedure to diagnose and replace, if necessary, an automatic transmission ... Tucson (TL) 2.0L/2.4L.'))));

-- ---------- H9. Відклики і кампанії покоління ----------

select pg_temp.stage('H-080#a', 'tucson_tl_24', 'gen:tl', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      pg_temp.p_num('model_year', 2019, 2019, 1),
      pg_temp.p_date('production_date', date '2018-09-01', date '2019-07-31', 2)),
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-27', null, null, 'supports', '2019-2019 Hyundai Tucson Production Dates: SEP 01, 2018 - JUL 31, 2019. Certain Model Year 2019 Hyundai Tucson vehicles ... may contain a defective circuit board in the ABS brake hydraulic electronic control unit (HECU).'))));

select pg_temp.stage('H-080#b', 'tucson_tl_24', 'gen:tl', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      ...
      pg_temp.p_date('production_date', date '2019-12-01', date '2020-03-31', 2)),
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-27', null, null, 'supports', '2020-2020 Hyundai Tucson Production Dates: DEC 01, 2019 - MAR 31, 2020.'))));

select pg_temp.stage('H-080#c', 'tucson_tl_24', 'gen:tl', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      pg_temp.p_num('model_year', 2021, 2021, 1),
      pg_temp.p_date('production_date', date '2020-06-23', date '2020-06-23', 2)),
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-27', null, null, 'supports', '2021-2021 Hyundai Tucson ... produced on 06/23/2020 ... Production Dates: JUN 23, 2020 - JUN 23, 2020.'))));

select pg_temp.stage('H-080#d', 'tucson_tl_24', 'gen:tl', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_num('model_year', 2018, 2018, 1)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-H-OFF-29', null, null, 'supports', 'Hyundai Motor America recalled certain 2019-2021 Tucson vehicles on September 4, 2020. On December 30, 2020, Hyundai expanded the recall population, and added certain 2016-2018 Tucson vehicles.'),
      pg_temp.ev('S-H-OFF-28', null, null, 'context', 'This TSB supersedes TSB# 20-01-040H, expanding model year applicability and adding procedures / parts information for 2016-2018MY vehicles.'))));

select pg_temp.stage('H-081', 'tucson_tl_24', 'issue:tl_hecu_fire', 'official_fact', 'high',
...
select pg_temp.stage('H-082', 'tucson_tl_24', 'gen:tl', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_ref('equipment_absent', 'eq:tucson_push_start', 1)),
    'ev', jsonb_build_array(pg_temp.ev('S-H-OFF-32', null, null, 'supports', 'In November 2021, engine immobilizers became standard on all Hyundai vehicles produced. Vehicles with a push button ignition are equipped with an immobilizer and therefore Campaign 993 does not apply to them. Phase 2: ... Tucson 2011-2022, June 2023 (estimated). Vehicles without immobilizers have key ignition steering columns (No push button Start/Stop Ignition).'))));

-- ---------- H10. Синтез ----------

select pg_temp.stage('H-090', 'tucson_tl_24', 'ver:tucson24', 'calcar_synthesis', 'high',
...
select pg_temp.stage('H-032', 'tucson_tl_24', 'ver:tucson24', 'calcar_synthesis', 'high',
...
select pg_temp.stage('H-042', 'tucson_tl_24', 'ver:tucson24', 'calcar_synthesis', 'high',
