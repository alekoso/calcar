...
-- Джерело: 123_candidates_bmw_530i.sql
--
...
select mi_load.stage('G-001', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-01', null, null, 'supports', 'Engine code B46B20O0, 248 hp at 5,200 to 6,500 rpm, 258 lb-ft at 1,450 to 4,800 rpm.'),
      mi_load.ev('S-G-OFF-04', null, null, 'context', 'The 2021 car is described with the B48B20O1 at the same 248 hp and 258 lb-ft.'))));

select mi_load.stage('G-002', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(mi_load.p_num('model_year', 2021, null, 1)),
    'ev', jsonb_build_array(mi_load.ev('S-G-OFF-04'))));

select mi_load.stage('G-003', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-01', null, null, 'supports', '8-speed automatic (8HP50) with sport mode and shift paddles standard.'),
      mi_load.ev('S-G-OFF-02', 'doc:pricing-guide-my2018', null, 'supports', '2TB Sport Automatic Transmission, STD on the 530i xDrive Sedan.'))));

-- Офіційний бюлетень називає родину роздатки (ATX13-x) і відносить до неї
-- G30; номер із дефісом дає лише каталог запчастин.
select mi_load.stage('G-004', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-12', null, null, 'supports', 'Jerking or shuddering from the driveline (xDrive transfer case ATX13-x), models include G30 (5 Series Sedan).'),
      mi_load.ev('S-G-MKT-01', null, null, 'supports', 'Transfer box ATC13 part numbers for the 2018 BMW 530i xDrive Sedan (G30), DTF 1 fluid.'))));

select mi_load.stage('G-005', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(mi_load.ev('S-G-OFF-01'))));

select mi_load.stage('G-006', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      ...
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(mi_load.ev('S-G-OFF-05'))));

select mi_load.stage('G-007', 'g30_530ix', 'vmy:530ix_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-02', 'doc:pricing-guide-my2018', null, 'supports', '24X 18 inch double-spoke wheels style 634 with all-season run-flat tires 245/45 R18, 2TB, 5A2, 524, 609, 3AG, 403, 481, 8KL Oil Chg 10,000 mls/12 months: STD on the 530i xDrive Sedan.'),
      mi_load.ev('S-G-OFF-01', null, null, 'supports', 'Sport design with 18-inch wheels, sport seats, iDrive 6.0 with 10.25-inch screen, LED headlights.'))));

select mi_load.stage('G-008', 'g30_530ix', 'vmy:530ix_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-02', 'doc:pricing-guide-my2018', null, 'supports', '530i xDrive Sedan, start of production 07/2017, base price 54,700; ZDH Dynamic Handling Package 1,950: 223, 2NH, 2VA, 2VH.'))));

select mi_load.stage('G-009', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      ...
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-03', null, null, 'supports', 'The 2020 5 Series Sedans began production in July 2019; Live Cockpit Plus (6U2) standard, Premium Package with Live Cockpit Professional (6U3), Comfort Access (322) on 530i.'),
      mi_load.ev('S-G-OWN-10', 'thread:bp-1626021', null, 'context', 'Owners confirm the iDrive 7 head unit and digital cluster from late July 2019 production.'))));

select mi_load.stage('G-010', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_num('model_year', 2017, 2019, 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-01', null, null, 'supports', 'iDrive 6.0 with 10.25-inch screen.'),
      mi_load.ev('S-G-OFF-03', null, null, 'context', 'The seventh generation arrived with model year 2020.'))));

-- ---------- G2. Відклики і кампанії ----------

select mi_load.stage('G-011', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_date('production_date', date '2018-05-16', date '2018-06-13', 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-06', null, null, 'supports', 'An updated firmware level of the crankshaft sensor semiconductor contained an error which could lead to a processing failure of the input from the crankshaft reluctor ring; on September 5, 2018 BMW upgraded the emissions recall to a safety recall for gasoline engine vehicles.'),
      mi_load.ev('S-G-OFF-17', null, null, 'supports', 'Recall 18V465000 is listed for the 2018 BMW 530i.'),
      mi_load.ev('S-SEARCH', null, null, 'context', 'Third party summaries give the affected production range as May 16 to June 13, 2018; the primary report read here carries the chronology and the model list but not the dates.'),
      mi_load.ev('S-G-OWN-06', 'thread:bp-1851182', null, 'context', 'A California 530i owner mentions the fuel pump sensor recall being done.'))));

select mi_load.stage('G-012', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      ...
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-07'), mi_load.ev('S-G-OFF-08'), mi_load.ev('S-G-OFF-17'))));

select mi_load.stage('G-013', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_num('model_year', 2017, 2017, 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(mi_load.ev('S-G-OFF-09'), mi_load.ev('S-G-OFF-17'))));

-- xDrive-специфічний відклик: subject це версія xDrive, тому на 530i з
-- заднім приводом він не потрапляє.
select mi_load.stage('G-014', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_date('production_date', date '2020-05-29', date '2020-06-26', 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-10', null, null, 'supports', 'Approximately 4 vehicles have been assembled with a left output shaft that may not have been produced to specifications; production dates May 29, 2020 to June 26, 2020; component part number 5 Series left 8664049; supplier GKN Driveline.'))));

select mi_load.stage('G-015', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_date('production_date', date '2019-06-12', date '2021-06-23', 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-11', null, null, 'supports', '2020-2022 BMW 5 Series, 530i and 530i xDrive, production dates Jun 12, 2019 to Jun 23, 2021, 22,804 vehicles; water could contact the starter electrical relay and lead to corrosion; in an extreme case this could cause a thermal event when the vehicle is parked and the ignition is off; consumer advisories: do not drive, park outside; engine starter part 8671503, Valeo.'),
      mi_load.ev('S-G-OFF-17', null, null, 'supports', 'Recall 25V636000 is listed for the 2020 BMW 530i.'),
      mi_load.ev('S-G-OWN-12', 'odi:11724573', '{"age_years":6}'::jsonb, 'context', 'A 2020 530i owner reports the car catching fire while driving in March 2026 with no warning smoke.'))));
...
select mi_load.stage('G-016', 'g30_530ix', 'issue:g30_xdrive_shudder', 'known_issue', 'high',
...
select mi_load.stage('G-017', 'g30_530ix', 'maint:atc13_fluid', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-12', null, null, 'supports', 'Use DTF-1 P/N 83 22 2 409 710 (0.7 liter); replace the oil filler plug P/N 33 11 7 525 064, tighten to 60 Nm; re-calibrate the VTG using ISTA.'),
      mi_load.ev('S-G-OWN-13', 'thread:bp-1700544', null, 'supports', 'Transfer box: DTF 1 75W GL-4, BMW part 83222409710, capacity 0.7 L.'),
      mi_load.ev('S-G-MKT-01', null, null, 'supports', 'DTF 1 transmission fluid 83222409710, 1000 ml, listed for the 2018 530i xDrive transfer box.'))));

select mi_load.stage('G-018', 'g30_530ix', 'maint:atc13_fluid', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-13', 'user:frozen-fractals', '{"mileage_km":120000}'::jsonb, 'supports', 'Capacities quoted: transfer box DTF 1 0.7 L, rear differential G1 75W85 GL-4 0.8 L, front differential G2 75W85 GL-5 0.6 L.'),
      mi_load.ev('S-G-OWN-08', 'user:frozen-fractals', '{"mileage_km":120000}'::jsonb, 'supports', '2018 540i xDrive at 75,000 miles: oil changes, transmission fluid, transfer box fluid, front and rear differential fluid changes done by the owner.'),
      mi_load.ev('S-G-OWN-14', 'thread:bp-2095206', '{"mileage_km":97000}'::jsonb, 'supports', '2021 540i xDrive at about 60,000 miles: spark plugs, front and rear differential fluid, transfer case fluid and transmission fluid with pan; fluids and plugs looked fine.'))));
...
-- майстерня.
select mi_load.stage('G-045', 'g30_530ix', 'maint:zf8hp50_atf', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-03', null, null, 'supports', 'ZF designates the fill maintenance-free but still recommends changing it at about 150,000 km, sooner under heat and load; our practical first service window is roughly 50,000 to 70,000 miles; shudder on acceleration, harsh 1-2 or 2-3 upshifts, delayed engagement and clunking into first gear appear before warning lights.'),
      mi_load.ev('S-SPEC-13', null, null, 'supports', 'Workshop article contrasting the BMW lifetime fluid claim with the ZF service interval.'))));

-- ---------- G4. Обслуговування мотора ----------

select mi_load.stage('G-019', 'g30_530ix', 'maint:b46_oil', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-02', 'doc:pricing-guide-my2018', null, 'supports', '8KL Oil Chg 10,000 mls/12 months, STD.'))));

select mi_load.stage('G-020', 'g30_530ix', 'maint:b46_oil', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-13', null, null, 'supports', 'The B46 uses a very thin oil, a 0W20 with either LL14 or LL17 formulas; our oil change recommendation is 5,000 miles.'),
      mi_load.ev('S-G-SPEC-05', null, null, 'supports', 'Long oil intervals of 30,000 km wear the guides prematurely; change oil every 10,000 to 15,000 km maximum.'),
      mi_load.ev('S-G-SPEC-04', null, null, 'supports', 'Timing chain wear on the B48 can occur if oil changes are extended excessively.'))));

select mi_load.stage('G-021', 'g30_530ix', 'maint:b46_plugs', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-17', 'thread:bp-2024681', '{"mileage_km":96000}'::jsonb, 'supports', 'OEM spark plugs come with a 0.7 mm gap; at 60k it is time to renew the plugs with the stock gap; do not gap iridium plugs.'),
      mi_load.ev('S-G-OWN-17', 'thread:bp-2116229', '{"mileage_km":63000}'::jsonb, 'supports', 'Changed plugs at 39K while chasing a rough idle; new plugs and coils fixed it. The OEM NGK plug SILZKGR8E8S is listed for B46, B48, B58TU and S58.'))));

-- ---------- G5. Система охолодження: корпус масляного фільтра ----------

select mi_load.stage('G-022#a', 'g30_530ix', 'issue:b48_oil_filter_housing', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-01', null, null, 'supports', 'The plastic oil filter housing serves as a junction point for coolant passages; coolant can either leak externally or seep internally into the engine oil; the housing typically fails around 55,000 miles; we have installed this upgrade on dozens of B48 engines.'),
      mi_load.ev('S-G-SPEC-02', null, null, 'supports', 'Oil filter housing: when gaskets fail you may see both coolant and oil leaks; everything under the intake gets cooked by heat; one of the most common issues we see on newer BMWs with B46, B48 and B58 engines.'),
      mi_load.ev('S-G-LEG-01', null, null, 'supports', 'The polycarbonate oil filter housings allegedly become embrittled due to repeated heating and cooling cycles, causing internal wall structures to fail or warp and sealing gaskets to fail, resulting in loss of engine coolant; 2014-2021 BMW 1 to 5 Series, X1 to X4 and MINI with the B46, B48 and B58.'),
      mi_load.ev('S-G-OFF-13', null, null, 'context', 'Only listed vehicles with the B46D, B48P or XB1G four-cylinder engines: the seal for the oil filter housing could exert excessive pressure to the bushing/insert, deform it and create an external coolant leak; replace the gaskets and the redesigned bushing.'),
      mi_load.ev('S-G-OWN-01', 'thread:bp-2051536', '{"mileage_km":193000}'::jsonb, 'supports', '2017 530i at 120,000 miles: coolant dripping rapidly while parked, plastic oil filter housing with a cracked coolant passage missing a piece of the lip; intake manifold removal required; saved about 3,000 dollars against the dealer.'),
      mi_load.ev('S-G-OWN-03', 'thread:bf-1466668', '{"mileage_km":180000}'::jsonb, 'supports', '2019 530i xDrive at 112,000 miles: coolant appearing beside the oil drain plug after ten minutes of running, traced to the oil filter housing gasket; housing and gaskets replaced.'),
      mi_load.ev('S-G-OWN-02', 'thread:bp-2144791', '{"mileage_km":137000}'::jsonb, 'supports', '2018 530i bought at 36,000 miles: oil filter housing replaced in December 2023 after turbo coolant lines and reservoir, then upper radiator hose, radiator and water pump housing gasket by 85,000 miles.'),
      mi_load.ev('S-G-OWN-05', 'thread:bf-1403683', '{"mileage_km":97000}'::jsonb, 'supports', 'B48 at 60,000 miles: coolant leak, cracked housing with a broken o-ring lip, about 3,000 dollars at the dealer; 2017 330i owners between 54,000 and 94,000 miles at 2,000 to 3,000 dollars, one housing failed twice.'))));

select mi_load.stage('G-022#b', 'g30_530ix', 'issue:b48_oil_filter_housing', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-01', 'thread:bp-2051536', '{"mileage_km":193000}'::jsonb, 'supports', '2017 530i at 120,000 miles, housing cracked; dealer repair on a B58 quoted at 2,400 dollars.'),
      mi_load.ev('S-G-OWN-03', 'thread:bf-1466668', '{"mileage_km":180000}'::jsonb, 'supports', '2019 530i xDrive at 112,000 miles, housing gasket, owner repair.'),
      mi_load.ev('S-G-OWN-02', 'thread:bp-2144791', '{"mileage_km":137000}'::jsonb, 'supports', '2018 530i, housing replaced in December 2023 on the way to 85,000 miles.'),
      mi_load.ev('S-G-OWN-05', 'thread:bf-1403683', '{"mileage_km":97000}'::jsonb, 'supports', 'B48 at 60,000 miles about 3,000 dollars at the dealer; 2017 330i owners at 54,000 to 94,000 miles, 2,000 to 3,000 dollars, one repeat failure.'),
      mi_load.ev('S-G-SPEC-15', null, null, 'context', 'Failures commonly reported between 60,000 and 100,000 miles; replacement is a 6 to 9 hour job requiring removal of the intake manifold.'))));

-- ---------- G6. Система охолодження: лінії турбіни, бачок, помпа, вентиляційна трубка ----------

select mi_load.stage('G-023', 'g30_530ix', 'issue:b46_turbo_coolant_lines', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-04', 'thread:bf-1472082', '{"mileage_km":93000}'::jsonb, 'supports', 'Thread title: 2018 BMW 530i, 58K miles, turbo coolant lines leaking.'),
      mi_load.ev('S-G-OWN-02', 'thread:bp-2144791', '{"age_years":4}'::jsonb, 'supports', '2018 530i: turbo coolant lines in September 2022, then the coolant reservoir, the return hose, the reservoir cap, the Y hose, the oil filter housing, the upper radiator hose, the radiator and the water pump housing gasket.'))));

select mi_load.stage('G-024', 'g30_530ix', 'issue:g30_expansion_tank', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-26', 'user:540iSUP', '{"mileage_km":72000}'::jsonb, 'supports', 'G30 540i at 45,000 miles: expansion tank crack and turbo lines, low coolant warning every three days, covered by the dealer.'),
      mi_load.ev('S-G-OWN-26', 'user:MustafaNajmiKhan', '{"mileage_km":80000}'::jsonb, 'supports', 'G30 540i at 80,000 km: crack in the expansion tank, 285 Canadian dollars plus tax.'),
      ...
      mi_load.ev('S-G-OWN-02', 'thread:bp-2144791', '{"mileage_km":137000}'::jsonb, 'supports', '2018 530i: coolant reservoir leaking, return hose, reservoir cap and Y hose under the reservoir replaced.'),
      mi_load.ev('S-G-MKT-04', null, null, 'context', 'One expansion tank part, 17139846642, is listed for the G30 530i and 540i; the N63 M550i uses a different tank.'))));

select mi_load.stage('G-025', 'g30_530ix', 'issue:b48_water_pump', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-02', 'thread:bp-2144791', '{"mileage_km":137000}'::jsonb, 'supports', '2018 530i: water pump housing gasket replaced in November 2024 at about 85,000 miles.'),
      mi_load.ev('S-G-SPEC-16', null, null, 'supports', 'Failures reported from 20,000 to over 80,000 miles, a common point around 50,000; leaks from the weep hole; no active recall.'),
      mi_load.ev('S-G-SPEC-18', null, null, 'context', 'Average water pump replacement on the 330i between 938 and 1,154 dollars.'))));

select mi_load.stage('G-026#a', 'g30_530ix', 'issue:b48_head_vent_line', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-14', null, null, 'supports', 'This Service Action involves F22, F23, F30, F31, F32, F33, F34 and F36 vehicles produced from April 24, 2015 to September 24, 2019; the quick disconnect coupling on the cylinder head coolant vent line could break at the cylinder head; the coolant line cannot handle excessive high temperatures over the lifetime of the part; part 17 12 9 845 173.'),
      mi_load.ev('S-G-MKT-02', null, null, 'supports', 'BMW 530iX hose, cylinder head to expansion tank, part 17129844478 (supersedes 17128602600).'),
      mi_load.ev('S-G-OWN-20', 'thread:bp-1889354', null, 'context', 'F30 and F32 owners describe the coupling snapping on the highway and rapid overheating, replaced free under the action.'))));

select mi_load.stage('G-026#b', 'g30_530ix', 'issue:b48_head_vent_line', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    'importance', 2,
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-09', 'thread:bf-1416639', null, 'supports', 'B46 engine coolant leaks and heat management concerns; the coolant bypass line from the block fails a lot.'),
      mi_load.ev('S-G-OWN-18', 'thread:bf-1431511', '{"mileage_km":48000}'::jsonb, 'context', '2018 330i: the hard coolant line broke and was replaced with a revised part under a recall; another B46 owner at 30,000 miles topped up coolant twice before the line was swapped.'),
      mi_load.ev('S-G-SPEC-08', null, null, 'context', 'The coolant vent line between head and tank cracks and leaks coolant rapidly.'))));

-- ---------- G7. Мотор: вентиляція картера, патрубок наддуву, натягувач, нагар, ланцюг, ТНВД ----------

select mi_load.stage('G-027', 'g30_530ix', 'issue:b48_pcv_diaphragm', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-07', null, null, 'supports', 'The PCV valve integrated into the valve cover can tear, creating a whistling noise at idle and high oil consumption; the entire cover assembly must usually be replaced.'),
      mi_load.ev('S-G-SPEC-05', null, null, 'supports', 'Valve cover gasket and PCV valve: whistling noise at idle and high oil consumption around 100,000 km.'),
      mi_load.ev('S-G-SPEC-04', null, null, 'supports', 'Valve cover gasket leaks at 70,000 to 100,000 miles.'))));

select mi_load.stage('G-028', 'g30_530ix', 'issue:b48_charge_pipe', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    'importance', 2,
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-05', null, null, 'supports', 'Charge pipe: loud pop while driving, total loss of power, check engine light; aluminium replacement kits exist.'),
      mi_load.ev('S-G-SPEC-04', null, null, 'context', 'Plastic charge pipes are prone to failure as the plastic ages or if boost increases.'))));

select mi_load.stage('G-029', 'g30_530ix', 'issue:b48_belt_tensioner', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    'importance', 2,
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-11', null, null, 'supports', 'A rattling or chirping noise from the front of the engine at idle, most noticeable on a cold start, that goes away with slight pressure on the tensioner housing; no recalls or bulletins as of mid 2024.'))));

select mi_load.stage('G-030', 'g30_530ix', 'issue:b48_intake_carbon', 'specialist_practice', 'low',
  ...
  jsonb_build_object(
    ...
    'causal', 'plausible_mechanism',
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-04', null, null, 'supports', 'The B48 is prone to carbon build-up on the intake valves; walnut blasting every 50,000 to 60,000 miles.'),
      mi_load.ev('S-G-SPEC-05', null, null, 'supports', 'Carbon build-up on the intake valves around 80,000 km.'),
      mi_load.ev('S-G-OWN-14', 'thread:bp-2095206', null, 'context', 'One owner recommends intake valve cleaning at four to five years.'))));

select mi_load.stage('G-031', 'g30_530ix', 'issue:b48_timing_chain', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-07', 'thread:bp-2072367', null, 'supports', 'No horror stories when researching G30 reliability threads; the B48 is considered a better engine than the N20.'),
      mi_load.ev('S-G-OWN-06', 'thread:bp-1851182', null, 'supports', 'No timing chain report among 2018 530i owners.'),
      mi_load.ev('S-G-SPEC-04', null, null, 'context', 'Timing chain wear is not the structural failure risk that the N20 chain represented.'),
      mi_load.ev('S-G-SPEC-14', null, null, 'context', 'Symptoms listed as startup rattle and rough idle, no build years and no failure figures.'),
      mi_load.ev('S-G-AGG-02', null, null, 'context', 'The technical update introduced a one-part timing chain instead of the earlier two-part chain.'))));

select mi_load.stage('G-032', 'g30_530ix', 'issue:b46_hpfp', 'known_issue', 'low',
  ...
  jsonb_build_object(
    'importance', 2,
    'ev', jsonb_build_array(
      mi_load.ev('S-G-AGG-01', null, null, 'supports', 'High-pressure fuel pumps can fail, leading to engine misfires, rough idling, hesitation during acceleration and even stalling.'))));

select mi_load.stage('G-033', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      ...
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-17', null, null, 'supports', 'Recalls by model year for make bmw model 530i: 2017 one, 2018 two, 2019 one, 2020 five, none of them fuel or cooling related.'),
      mi_load.ev('S-G-AGG-01', null, null, 'contradicts', 'The aggregator lists high pressure fuel pump and injector failures as common problems of the 530i.'))));

-- ---------- G8. Продовження гарантії ----------

-- Джерело S-OFF-13 з еталонної картки M550i: той самий бюлетень.
select mi_load.stage('G-034', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-OFF-13', null, null, 'supports', 'Limited warranty extension for the turbocharger wastegate valve actuator to 15 years or 150,000 miles: G30 2018 to 2020 530e Sedan and 530e xDrive Sedan (XB1H), February 2017 to June 2020.'))));

select mi_load.stage('G-035', 'g30_530ix', 'issue:g30_air_flaps', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_date('production_date', date '2016-11-03', date '2019-06-18', 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-15', null, null, 'supports', 'G30 2017 to 2019 530i xDrive Sedan, November 3, 2016 to June 18, 2019, B46O; the radiator grille upper and lower active air flaps limited warranty is extended to 15 years/150,000 miles as determined from the original in-service date; air flap issues caused by debris or blockage from outside influences are not a defect.'),
      mi_load.ev('S-G-OWN-25', 'thread:bp-2004635', null, 'supports', 'G30 owners with the lower grille stuck open and clicking had the repair covered under the 15 year, 150,000 mile extension; a 2019 540xi at 23,000 miles logged grille shutter and cruise control codes.'),
      mi_load.ev('S-G-OWN-16', 'thread:bf-1411186', null, 'context', 'A 2017 530i xDrive owner names the front intake vent flaps as the one known weakness, with the warranty extended to 15 years or 150,000 miles.'))));

select mi_load.stage('G-036', 'g30_530ix', 'ver:530ix_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      mi_load.p_date('production_date', date '2016-10-11', date '2020-06-26', 1),
      mi_load.p_tag('market_sold', 'US', 2)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-16', null, null, 'supports', 'G30 2017 to 2020 530i xDrive Sedan, October 11, 2016 to June 26, 2020, B46O/D: the NVLD limited warranty is extended to 15 years/150,000 miles as determined from the original in-service date; over time the leak diagnosis module component material may fail.'))));

-- ---------- G9. Кузов, електрика, шасі покоління ----------

select mi_load.stage('G-037', 'g30_530ix', 'issue:g30_seat_mat', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-12', 'odi:11697612', '{"age_years":7}'::jsonb, 'supports', 'Passenger seat occupancy sensor faulty causing restraint system malfunction and seat belt warning.'),
      mi_load.ev('S-G-OWN-12', 'odi:11669239', '{"age_years":6}'::jsonb, 'supports', 'It keeps coming up with the error message passenger restraint system malfunction.'),
      mi_load.ev('S-G-OWN-12', 'odi:11654120', '{"age_years":7}'::jsonb, 'supports', 'The seatbelt and passenger seat fail to recognize a passenger is occupying the seat and turn off the airbag.'),
      mi_load.ev('S-G-OWN-12', 'odi:11652985', '{"age_years":6}'::jsonb, 'supports', 'Passenger restraint system light stays on.'),
      mi_load.ev('S-G-OWN-12', 'odi:11648020', '{"age_years":7}'::jsonb, 'supports', 'An airbag light and a malfunction error read that the passenger restraint system has malfunctioned.'),
      mi_load.ev('S-G-OWN-12', 'odi:11641549', '{"age_years":5}'::jsonb, 'supports', 'Constantly pops up a message for passenger restraint system malfunction.'),
      mi_load.ev('S-G-OWN-12', 'odi:11634477', '{"age_years":7}'::jsonb, 'supports', 'Passenger restraint system malfunction, described on forums as a common problem on these vehicles.'),
      mi_load.ev('S-G-OWN-12', 'odi:11634005', '{"age_years":7}'::jsonb, 'supports', 'The passenger restraint system malfunction warning comes on randomly; the seat belt light comes on with a wallet on the seat.'),
      mi_load.ev('S-G-OWN-12', 'odi:11605584', '{"age_years":6}'::jsonb, 'supports', 'Passenger restraint system malfunction.'),
      mi_load.ev('S-G-OWN-12', 'odi:11604742', '{"age_years":6}'::jsonb, 'supports', 'Four wheel drive and passenger restraint warnings appeared after parking.'),
      mi_load.ev('S-G-OWN-12', 'odi:11603633', '{"age_years":6}'::jsonb, 'supports', 'With a passenger in the front seat the airbag is disabled.'),
      mi_load.ev('S-G-OWN-11', 'user:steve090619', null, 'supports', 'Passenger restraint system malfunction warning and airbag off light, sensor mat failure, 2,700 dollars out of warranty.'),
      mi_load.ev('S-G-OWN-11', 'user:dscabra', null, 'supports', 'Pressure pad in the seat bottom, 2,700 dollars, covered by the certified pre-owned warranty.'),
      mi_load.ev('S-G-OWN-11', 'user:grubssin', null, 'supports', 'Seat occupancy mat defect, more than 2,000 dollars, covered after escalation.'),
      mi_load.ev('S-G-SPEC-10', null, null, 'context', 'A frequent complaint on G30 forums is an intermittent passenger restraint system malfunction warning; quotes of 2,130 to 3,500 dollars.'))));

select mi_load.stage('G-038', 'g30_530ix', 'issue:g30_ac_evaporator', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-15', 'user:NGT2', '{"mileage_km":62000}'::jsonb, 'supports', '2018 540i xDrive at 38,500 miles: steering column sticking, rear window shade switch, ambient light failure, air conditioning evaporator replacement, all under warranty.'),
      mi_load.ev('S-G-OWN-16', 'thread:bf-1411186-19', '{"mileage_km":97000}'::jsonb, 'supports', '2017 530i at 60,000 miles: the air conditioning issue was resolved by a campaign, otherwise the most bullet-proof vehicle owned.'),
      mi_load.ev('S-G-REV-01', null, null, 'context', 'A 2018 530i owner reported climate control blowing hot air from an evaporator leak.'))));

select mi_load.stage('G-039', 'g30_530ix', 'issue:g30_tension_strut', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-23', 'user:CarlosM4', '{"mileage_km":48000}'::jsonb, 'supports', '2018 540i at 30,000 miles: random noises during braking and after steering; tension strut bushing deterioration; noise gone after replacement.'),
      mi_load.ev('S-G-OWN-23', 'user:eric_gm', '{"mileage_km":40000}'::jsonb, 'supports', 'G30 540i at 25,000 miles: slight loose feeling over bumps; thrust arm bushings with cracks visible only under stress; both arms replaced.'),
      mi_load.ev('S-G-SPEC-09', null, null, 'context', 'The large fluid-filled bushings are the weak point; the part differs between rear wheel drive and xDrive models.'),
      mi_load.ev('S-G-OWN-08', 'thread:bp-1834317', null, 'context', 'At 80,000 to 100,000 miles you start replacing control arms and bushings.'))));

select mi_load.stage('G-040', 'g30_530ix', 'issue:g30_nbt_evo_hdd', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(mi_load.p_num('model_year', 2017, 2019, 1)),
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-24', 'user:mhrxn', '{"age_years":6}'::jsonb, 'supports', '2017 530i: fault B7F853, navigation stuck loading, Bluetooth audio and CarPlay dead after a disinfectant spray in the vents.'),
      mi_load.ev('S-G-OWN-24', 'user:jfirko', '{"age_years":5}'::jsonb, 'supports', '2018 G30: same symptoms after a vent deodoriser; residue on the board; drive replaced with a 240 GB SSD and initialised remotely for 100 dollars.'),
      mi_load.ev('S-G-SPEC-12', null, null, 'context', 'The mechanical drives in NBT and NBT EVO head units are a known failure point; heat and vibration cause reboot loops and freezing.'))));

-- ---------- G10. Ревізії мотора, які документ виробника не підтверджує ----------

select mi_load.stage('G-041', 'g30_530ix', 'var:b46b20o0', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OWN-21', 'thread:bp-1702754', null, 'supports', 'B46 is the B48 engine but with SULEV parts for emissions regulations; most US cars are B46, the rest of the world is B48.'),
      mi_load.ev('S-G-SPEC-17', null, null, 'supports', 'The stock B46 and B48 have the same power and torque output; the differences are speculated to be the catalytic converter, fuel lines and emission parts.'))));

select mi_load.stage('G-042', 'g30_530ix', 'var:b48b20o1', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-AGG-02', null, null, 'supports', 'Non-TU: Bosch HDEV5 200 bar; TU: Bosch HDEV6 350 bar; new one-part timing chain instead of the earlier two-part; separate cooling circuits for the cylinder head and crankcase; crankshaft 1 kg lighter.'),
      mi_load.ev('S-G-SPEC-04', null, null, 'supports', 'The technical update improved the crankshaft, raised injection pressure to 350 bar and revised the piston rings.'))));

-- ---------- G11. Синтез CalCar ----------

-- Опори підставляються після публікації звичайних клеймів у
-- 131_synthesis_bmw_530i.sql; тут синтез лише стає у staging.
select mi_load.stage('G-043', 'g30_530ix', 'fam:b48', 'calcar_synthesis', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-SPEC-02', null, null, 'supports', 'Everything under the intake gets cooked by heat; replace the hoses, fittings and gaskets around the heater management module together.'),
      mi_load.ev('S-G-OWN-02', 'thread:bp-2144791', '{"mileage_km":137000}'::jsonb, 'supports', 'A 2018 530i lost nine cooling components one after another between 60,000 and 85,000 miles.'))));

select mi_load.stage('G-044', 'g30_530ix', 'ver:530ix_g30', 'calcar_synthesis', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      mi_load.ev('S-G-OFF-01', null, null, 'supports', 'The 530i is the B46B20O0 four cylinder; the M550i is a different engine.'),
      mi_load.ev('S-G-OFF-12', null, null, 'supports', 'The transfer case bulletin covers every xDrive G30 regardless of engine.'))));
