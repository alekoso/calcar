...
-- Джерело: 105_entities_hyundai_tucson.sql
--
...
values (mi_load.mk('brand:hyundai', 'brand', 'Hyundai'), 'Hyundai', 'KR');

insert into mi.model_line (subject_id, brand_id, name)
values (mi_load.mk('line:tucson', 'model_line', 'Hyundai Tucson'), mi_load.sid('brand:hyundai'), 'Tucson');
...
insert into mi.generation (subject_id, model_line_id, platform_code, phase,
  ...
  (mi_load.mk('gen:tl', 'generation', 'Hyundai Tucson TL'),
   mi_load.sid('line:tucson'), 'TL', 'base', array['ice']::mi.powertrain[], 'ice_default',
...
insert into mi.vehicle_version (subject_id, generation_id, version_code, name_en, powertrain) values
  (mi_load.mk('ver:tucson24', 'vehicle_version', 'Hyundai Tucson TL 2.4 GDI'),
   mi_load.sid('gen:tl'), 'TL_THETA2_24', '2.4 GDI', 'ice');
...
insert into mi.version_market_year (subject_id, version_id, market_code, model_year,
  ...
  (mi_load.mk('vmy:tucson24_us_2018', 'version_market_year', 'Hyundai Tucson TL 2.4 GDI US MY2018'),
   mi_load.sid('ver:tucson24'), 'US', 2018, date '0001-01-01', 'unknown', date '9999-12-31', 'unknown'),
  (mi_load.mk('vmy:tucson24_us_2019', 'version_market_year', 'Hyundai Tucson TL 2.4 GDI US MY2019'),
   mi_load.sid('ver:tucson24'), 'US', 2019, date '0001-01-01', 'unknown', date '9999-12-31', 'unknown'),
  (mi_load.mk('vmy:tucson24_us_2020', 'version_market_year', 'Hyundai Tucson TL 2.4 GDI US MY2020'),
   mi_load.sid('ver:tucson24'), 'US', 2020, date '0001-01-01', 'unknown', date '9999-12-31', 'unknown'),
  (mi_load.mk('vmy:tucson24_us_2021', 'version_market_year', 'Hyundai Tucson TL 2.4 GDI US MY2021'),
   mi_load.sid('ver:tucson24'), 'US', 2021, date '0001-01-01', 'unknown', date '9999-12-31', 'unknown');
...
insert into mi.component_family (subject_id, brand_id, family_key, family_kind_code, architecture_en) values
  (mi_load.mk('fam:theta2', 'component_family', 'Hyundai Theta II inline four'), mi_load.sid('brand:hyundai'),
  ...
  (mi_load.mk('fam:hyundai_6at', 'component_family', 'Hyundai six-speed automatic transaxle'), mi_load.sid('brand:hyundai'),
...
insert into mi.component_variant (subject_id, family_id, variant_code, name_en,
    prod_from, prod_from_kind, prod_to, prod_to_kind) values
  (mi_load.mk('var:theta2_24_gdi', 'component_variant', 'Hyundai Theta II 2.4 GDI'), mi_load.sid('fam:theta2'),
   'THETA2_24_GDI', 'Theta II 2.4 litre gasoline direct injection, 2,359 cc, bore 88 mm, stroke 97 mm',
   date '0001-01-01', 'unknown', date '9999-12-31', 'unknown'),
  (mi_load.mk('var:tucson24_6at', 'component_variant', 'Hyundai six-speed automatic, Tucson TL 2.4'), mi_load.sid('fam:hyundai_6at'),
...
insert into mi.version_fitment (vmy_id, role_code, variant_id, fitment) values
  (mi_load.sid('vmy:tucson24_us_2018'), 'engine',       mi_load.sid('var:theta2_24_gdi'), 'standard'),
  (mi_load.sid('vmy:tucson24_us_2018'), 'transmission', mi_load.sid('var:tucson24_6at'),  'standard'),
  (mi_load.sid('vmy:tucson24_us_2019'), 'engine',       mi_load.sid('var:theta2_24_gdi'), 'standard'),
  (mi_load.sid('vmy:tucson24_us_2019'), 'transmission', mi_load.sid('var:tucson24_6at'),  'standard'),
  (mi_load.sid('vmy:tucson24_us_2020'), 'engine',       mi_load.sid('var:theta2_24_gdi'), 'standard'),
  (mi_load.sid('vmy:tucson24_us_2020'), 'transmission', mi_load.sid('var:tucson24_6at'),  'standard'),
  (mi_load.sid('vmy:tucson24_us_2021'), 'engine',       mi_load.sid('var:theta2_24_gdi'), 'standard'),
  (mi_load.sid('vmy:tucson24_us_2021'), 'transmission', mi_load.sid('var:tucson24_6at'),  'standard');
...
insert into mi.equipment_item (subject_id, brand_id, equipment_key, item_kind, name_en) values
  (mi_load.mk('eq:tucson_awd', 'equipment_item', 'Hyundai Tucson TL all-wheel drive'), mi_load.sid('brand:hyundai'),
   'tucson_tl_awd', 'system_config', 'All-wheel drive with AWD LOCK mode'),
  (mi_load.mk('eq:tucson_push_start', 'equipment_item', 'Hyundai Tucson TL smart key with push button start'), mi_load.sid('brand:hyundai'),
...
select mi_load.sid(v), mi_load.sid(i), 'optional'
...
insert into mi.subject_alias (target_subject_id, alias, alias_norm, lang, alias_kind, scope_kind, scope_subject_id) values
  (mi_load.sid('ver:tucson24'), '2.4L',         '2.4l',         'en', 'official',  'model_line', mi_load.sid('line:tucson')),
  (mi_load.sid('ver:tucson24'), 'Theta II 2.4', 'theta ii 2.4', 'en', 'legal',     'model_line', mi_load.sid('line:tucson')),
  (mi_load.sid('ver:tucson24'), '2.4',          '2.4',          'en', 'community', 'model_line', mi_load.sid('line:tucson'));
...
insert into mi.entitlement (subject_id, brand_id, entitlement_key, name_en, binding,
  ...
  (mi_load.mk('ent:tucson_theta_ext', 'entitlement', 'Theta II rod bearing warranty extensions TXXC and TXXI (Tucson TL 2.4)'),
   mi_load.sid('brand:hyundai'), 'theta2_rod_bearing_extension_tucson_tl', 'Engine long block warranty extensions TXXC and TXXI', 'vin',
   true, true, true,
   ...
   false, mi_load.sid('var:theta2_24_gdi'));

-- ---------- Проблеми ----------

insert into mi.issue (subject_id, issue_key, about_subject_id, name_en, mechanism_en, severity, sensitivity) values
  (mi_load.mk('issue:theta24_rod_bearing', 'issue', 'Theta II 2.4 GDI connecting rod bearing wear'),
   'theta2_24_rod_bearing_wear', mi_load.sid('var:theta2_24_gdi'),
   ...
   'catastrophic', 'mixed'),
  (mi_load.mk('issue:theta24_oil_consumption', 'issue', 'Theta II 2.4 GDI excessive oil consumption'),
   'theta2_24_oil_consumption', mi_load.sid('var:theta2_24_gdi'),
   'The engine burns oil between changes until the level is dangerously low',
   null, 'major', 'mileage'),
  (mi_load.mk('issue:tl_hecu_fire', 'issue', 'Hyundai Tucson TL ABS module short and engine compartment fire'),
   'tucson_tl_hecu_short', mi_load.sid('gen:tl'),
...
insert into mi.maintenance_item (subject_id, about_subject_id, service_kind_code, fluid_spec_code, capacity_note_en) values
  (mi_load.mk('maint:theta24_oil', 'maintenance_item', 'Tucson TL 2.4 GDI engine oil and filter'),
   mi_load.sid('var:theta2_24_gdi'), 'engine_oil', null, '4.8 litres (5.07 US quarts), SAE 5W-20 API and ILSAC latest'),
  (mi_load.mk('maint:theta24_plugs', 'maintenance_item', 'Tucson TL 2.4 GDI spark plugs'),
   mi_load.sid('var:theta2_24_gdi'), 'spark_plugs', null, null),
  (mi_load.mk('maint:theta24_coolant', 'maintenance_item', 'Tucson TL 2.4 GDI engine coolant'),
   mi_load.sid('var:theta2_24_gdi'), 'coolant', null, '7.7 litres (8.14 US quarts), phosphate based ethylene glycol'),
  (mi_load.mk('maint:tl24_atf', 'maintenance_item', 'Tucson TL 2.4 automatic transmission fluid'),
   mi_load.sid('var:tucson24_6at'), 'atf', null, '6.7 litres (7.08 US quarts) of ATF SP-IV'),
  (mi_load.mk('maint:tl_awd_transfer', 'maintenance_item', 'Tucson TL AWD transfer case oil'),
   mi_load.sid('eq:tucson_awd'), 'transfer_case_fluid', null, null),
  (mi_load.mk('maint:tl_awd_diff', 'maintenance_item', 'Tucson TL AWD rear differential oil'),
   mi_load.sid('eq:tucson_awd'), 'differential_fluid', null, null);
...
insert into mi.check_item (subject_id, test_method_code, scope_subject_id, why_en, proves_en,
  ...
  (mi_load.mk('chk:theta24_knock', 'check_item', 'Cold start and rev test for connecting rod knock'),
   'cold_start', mi_load.sid('var:theta2_24_gdi'),
  ...
  (mi_load.mk('chk:theta24_p1326', 'check_item', 'Read stored engine codes for P1326 on the Tucson 2.4'),
   'diagnostic_scan', mi_load.sid('var:theta2_24_gdi'),
  ...
  (mi_load.mk('chk:theta24_oil_level', 'check_item', 'Check the oil level on the dipstick of the Tucson 2.4'),
   'visual', mi_load.sid('var:theta2_24_gdi'),
   ...
   null, 'must', false, null),
  (mi_load.mk('chk:tucson24_records', 'check_item', 'Ask for oil change records and the Hyundai campaign history'),
   'documentation', mi_load.sid('ver:tucson24'),
   ...
   null, 'must', false, null),
  (mi_load.mk('chk:tucson24_extension_lookup', 'check_item', 'Ask a Hyundai dealer to look up T3G, campaign 953, TXXC and TXXI on the VIN'),
   'entitlement_verification', mi_load.sid('ver:tucson24'),
  ...
  (mi_load.mk('chk:tl_vin_engine', 'check_item', 'Read the eighth VIN character for the Tucson engine code'),
   'documentation', mi_load.sid('ver:tucson24'),
  ...
  (mi_load.mk('chk:tl_build_date', 'check_item', 'Read the manufacture month on the door jamb label of the Tucson'),
   'vin_build_sheet', mi_load.sid('gen:tl'),
  ...
  (mi_load.mk('chk:tl_recall_lookup', 'check_item', 'Look up open recalls on the Tucson VIN'),
   'documentation', mi_load.sid('gen:tl'),
   ...
   null, 'must', false, null),
  (mi_load.mk('chk:tl_awd_identify', 'check_item', 'Confirm all-wheel drive on the Tucson: AWD LOCK button and rear drive shaft'),
   'visual', mi_load.sid('ver:tucson24'),
  ...
  (mi_load.mk('chk:tl_ignition', 'check_item', 'Look for a key ignition barrel or an Engine Start/Stop button'),
   'visual', mi_load.sid('gen:tl'),
  ...
  (mi_load.mk('chk:tl24_transmission', 'check_item', 'Road test for transmission slip and read incorrect ratio codes'),
   'road_test', mi_load.sid('var:tucson24_6at'),
...
insert into mi.check_covers (check_id, target_subject_id, role) values
  (mi_load.sid('chk:theta24_knock'),            mi_load.sid('issue:theta24_rod_bearing'),     'detects'),
  (mi_load.sid('chk:theta24_p1326'),            mi_load.sid('issue:theta24_rod_bearing'),     'detects'),
  (mi_load.sid('chk:theta24_oil_level'),        mi_load.sid('issue:theta24_oil_consumption'), 'detects'),
  (mi_load.sid('chk:tucson24_extension_lookup'),mi_load.sid('ent:tucson_theta_ext'),         'verifies_state'),
  (mi_load.sid('chk:tl_vin_engine'),            mi_load.sid('var:theta2_24_gdi'),             'resolves_identity'),
  (mi_load.sid('chk:tl_awd_identify'),          mi_load.sid('eq:tucson_awd'),                 'resolves_identity'),
  (mi_load.sid('chk:tl_ignition'),              mi_load.sid('eq:tucson_push_start'),          'resolves_identity');
...
insert into mi.component_state_type (subject_id, state_key, state_kind, applies_to_subject_id,
  ...
  (mi_load.mk('state:theta24_ksds', 'component_state_type', 'Knock sensor detection software installed (campaign 953)'),
   'theta2_24_ksds_installed', 'retrofit', mi_load.sid('var:theta2_24_gdi'), null, true),
  (mi_load.mk('state:theta24_long_block', 'component_state_type', 'Theta II 2.4 long block replaced by a Hyundai dealer'),
   'theta2_24_long_block_replaced', 'replacement_reman', mi_load.sid('var:theta2_24_gdi'), null, true),
  (mi_load.mk('state:tl_hecu_fuse', 'component_state_type', 'ABS module fuse kit installed under recall 195'),
   'tucson_tl_hecu_fuse_kit', 'repair', mi_load.sid('gen:tl'), null, true);
