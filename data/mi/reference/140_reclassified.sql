...
select pg_temp.stage('C-037#r1', 'bmw', 'issue:n63_wastegate_actuator', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-024#r1', 'porsche', 'issue:958_hpfp', 'owner_pattern', 'medium',
...
-- властивість моделі.
select pg_temp.stage('P-051#a-r1', 'porsche', 'issue:958_transfer_case', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-023#r1', 'porsche', 'issue:958_aos', 'specialist_practice', 'medium',
...
select pg_temp.stage('P-060#a-r1', 'porsche', 'issue:958_air_strut', 'specialist_practice', 'medium',
...
select pg_temp.stage('T-052#r1', 'tesla', 'issue:yellow_border', 'specialist_practice', 'high',
...
select pg_temp.stage('T-051#r1', 'tesla', 'issue:cluster_flicker', 'specialist_practice', 'medium',
...
select pg_temp.stage('T-020#a-r1', 'tesla', 'var:pack_85_gen1', 'specialist_practice', 'high',
...
select pg_temp.stage('C-093#r1', 'bmw', 'ver:m550i_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-14'))));
...
select pg_temp.stage('C-066#r1', 'bmw', 'maint:n63tu2_radiators', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-067#r1', 'bmw', 'state:n63_thermostat_defeat', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-081#r1', 'bmw', 'maint:zf8hp75_atf', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-053#a-r1', 'porsche', 'maint:958_diff_fluid', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-072#r1', 'porsche', 'maint:958_drains', 'owner_pattern', 'medium',
...
select pg_temp.stage('P-082#r1', 'porsche', 'ver:cayenne_gts_958_1', 'owner_pattern', 'medium',
...
select pg_temp.stage('T-029#r1', 'tesla', 'maint:pack_charging_habit', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-072#r1', 'bmw', 'var:zf8hp75', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      ...
      pg_temp.ev('S-TUN-03', null, null, 'context',
...
select pg_temp.stage('P-081#r1', 'porsche', 'ver:cayenne_gts_958_1', 'calcar_synthesis', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-P-SPEC-13'), pg_temp.ev('S-P-LEG-03'))));
