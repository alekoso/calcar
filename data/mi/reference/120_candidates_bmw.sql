...
select pg_temp.stage('C-001', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-OFF-08'),
      pg_temp.ev('S-OFF-16'), pg_temp.ev('S-SPEC-01'))));

select pg_temp.stage('C-002', 'bmw', 'ver:m550i_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-SPEC-03'),
      pg_temp.ev('S-SEARCH', null, null, 'context',
        'The European rating of 462 PS and 650 Nm describes the same engine measured by a different method.'))));

select pg_temp.stage('C-003', 'bmw', 'vmy:m550i_us_2020', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-02'), pg_temp.ev('S-OWN-10'))));

select pg_temp.stage('C-004', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-SPEC-08'), pg_temp.ev('S-MKT-01'))));
...
select pg_temp.stage('C-005', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
  'The M550i xDrive G30 is built with the ATC13-1 transfer case.',
  jsonb_build_object(
    'value_kind', 'enum',
    'value', '{"transfer_case":"ATC13-1"}'::jsonb,
    'ev', jsonb_build_array(pg_temp.ev('S-MKT-01'), pg_temp.ev('S-SPEC-09'))));

select pg_temp.stage('C-006', 'bmw', 'ver:m550i_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_num('model_year', 2018, 2019)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-OFF-02'),
      pg_temp.ev('S-SEARCH', null, null, 'contradicts',
...
select pg_temp.stage('C-007', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-01'))));

select pg_temp.stage('C-008', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
...
select pg_temp.stage('C-009', 'bmw', 'ver:m550i_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-OWN-11'),
      pg_temp.ev('S-SEARCH', null, null, 'contradicts',
...
select pg_temp.stage('C-010', 'bmw', 'ver:m550i_g30', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-REV-01'), pg_temp.ev('S-SPEC-04'),
      pg_temp.ev('S-SEARCH', null, null, 'context',
        'European catalogues quote 1,885 to 1,990 kg by the DIN method.'))));

select pg_temp.stage('C-011', 'bmw', 'ver:m550i_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_tag('market_sold', 'US')),
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-REV-01'), pg_temp.ev('S-REV-02'))));

select pg_temp.stage('C-012', 'bmw', 'ver:m550i_g30', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_tag('market_sold', 'US')),
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-09'))));

select pg_temp.stage('C-013', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-10'))));

-- Знову official_fact без офіційного джерела: лише переказ продавця запчастин.
select pg_temp.stage('C-014', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-10'), pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-015', 'bmw', 'ver:m550i_g30', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-14'), pg_temp.ev('S-OWN-24'),
      pg_temp.ev('DOC2', null, null, 'context',
...
select pg_temp.stage('C-020', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-16'), pg_temp.ev('S-SPEC-01'), pg_temp.ev('S-SPEC-02'))));

select pg_temp.stage('C-021', 'bmw', 'var:n63b44t3', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-17'), pg_temp.ev('S-SPEC-01'))));

select pg_temp.stage('C-022', 'bmw', 'var:n63b44t3', 'official_fact', 'high',
  ...
  jsonb_build_object('ev', jsonb_build_array(pg_temp.ev('S-OFF-17'))));

select pg_temp.stage('C-023', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-16'), pg_temp.ev('S-SPEC-01'),
      pg_temp.ev('S-SPEC-06', null, null, 'contradicts',
        'A tuning shop article called the injectors piezo without separating the revisions.'))));

select pg_temp.stage('C-024', 'bmw', 'fam:n63', 'calcar_synthesis', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-16'), pg_temp.ev('S-OWN-01', null, '{"mileage_km":64000}'::jsonb),
      pg_temp.ev('S-OWN-05', null, '{"mileage_km":161000}'::jsonb))));

select pg_temp.stage('C-025', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-16'), pg_temp.ev('S-OFF-17'),
      pg_temp.ev('S-OWN-27', null, null, 'contradicts',
        'A forum contributor asserted that this revision already had a sprayed coating, which the training material contradicts.'))));

select pg_temp.stage('C-026', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-16'), pg_temp.ev('S-OWN-25', null, '{"mileage_km":90000}'::jsonb))));

-- ---------- B3. Мотор: надійність ----------

select pg_temp.stage('C-030', 'bmw', 'var:n63b44o2', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-01', 'thread:bp-1618778', '{"mileage_km":64000}'::jsonb),
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":161000}'::jsonb),
      pg_temp.ev('S-OWN-26', 'thread:bf-1380533', '{"mileage_km":90000}'::jsonb),
      pg_temp.ev('S-OWN-28', 'thread:bf-1360819', '{"age_years":2}'::jsonb),
      pg_temp.ev('S-OWN-29', 'thread:bp-1974364', '{"mileage_km":75000}'::jsonb),
      pg_temp.ev('S-LEG-01', null, null, 'contradicts',
        'The 2019 class action named the 2017 to 2019 M550i among the affected models.'))));

select pg_temp.stage('C-031', 'bmw', 'brand:bmw', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-11'))));

select pg_temp.stage('C-032', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
...
select pg_temp.stage('C-033', 'bmw', 'issue:n63r_map_thermostat', 'known_issue', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      pg_temp.p_ref('generation', 'gen:g30', 1),
      pg_temp.p_ref('generation', 'gen:g12', 1)),
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-04'))));

select pg_temp.stage('C-034', 'bmw', 'issue:n63r_map_thermostat', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-05'))));

select pg_temp.stage('C-035', 'bmw', 'issue:n63_turbo_coolant_lines', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(
      pg_temp.p_ref('generation', 'gen:g12', 1),
      pg_temp.p_date('production_date', date '2015-06-01', date '2017-01-31', 2)),
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-03'))));

select pg_temp.stage('C-036#a', 'bmw', 'issue:n63_cooling_age', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-05', 'thread:bp-2244036', '{"mileage_km":161000}'::jsonb),
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":161000}'::jsonb),
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":169000}'::jsonb))));

select pg_temp.stage('C-036#b', 'bmw', 'issue:n63_cooling_age', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-037', 'bmw', 'issue:n63_wastegate_actuator', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-02', 'thread:bp-2074062', '{"mileage_km":100000}'::jsonb),
      pg_temp.ev('S-OWN-03', 'thread:bp-2152583', '{"mileage_km":167000}'::jsonb),
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":169000}'::jsonb),
      pg_temp.ev('S-OWN-07', 'thread:bp-2017789', '{"mileage_km":93000}'::jsonb),
      pg_temp.ev('S-OWN-30', 'thread:bp-1905102', '{"mileage_km":51000}'::jsonb),
      pg_temp.ev('S-MKT-02'))));

select pg_temp.stage('C-038', 'bmw', 'issue:n63_wastegate_actuator', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_ref('generation', 'gen:g12')),
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-06'), pg_temp.ev('S-OFF-07'))));

select pg_temp.stage('C-039', 'bmw', 'ver:530e_g30', 'official_fact', 'high',
...
select pg_temp.stage('C-040', 'bmw', 'issue:n63_valve_stem_seals', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-SEARCH'), pg_temp.ev('S-SPEC-06'), pg_temp.ev('S-OFF-17'))));

select pg_temp.stage('C-041', 'bmw', 'issue:n63_upper_oil_pan', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-09', 'thread:bp-1801258', '{"mileage_km":65000}'::jsonb),
      pg_temp.ev('S-MKT-03'))));

select pg_temp.stage('C-042', 'bmw', 'var:n63b44o2', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    'causal', 'unknown',
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-05'), pg_temp.ev('S-SPEC-06'),
      pg_temp.ev('S-AGG-01', null, null, 'contradicts',
        'Aggregators carry timing chain stretch over to the M550i without evidence.'))));

select pg_temp.stage('C-043#a', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-18'))));

select pg_temp.stage('C-043#b', 'bmw', 'var:n63b44o2', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-18'), pg_temp.ev('S-SPEC-06'), pg_temp.ev('S-OWN-09'))));

select pg_temp.stage('C-044', 'bmw', 'issue:n63_intake_carbon', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-07'))));

select pg_temp.stage('C-045', 'bmw', 'var:n63b44o2', 'owner_pattern', 'low',
  'One owner reported failure of the accessory belt and its tensioner at 177,000 kilometres, accompanied by overheating.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-03', 'thread:bp-2152583', '{"mileage_km":177000}'::jsonb))));

select pg_temp.stage('C-046', 'bmw', 'var:n63b44o2', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":128000}'::jsonb))));

select pg_temp.stage('C-047', 'bmw', 'var:n63b44o2', 'owner_pattern', 'low',
  'One owner had the engine mounts replaced at forty months of age.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"age_years":3.3}'::jsonb))));

select pg_temp.stage('C-048#a', 'bmw', 'var:n63b44o2', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-03', 'thread:bp-2152583', '{"mileage_km":177000}'::jsonb),
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":161000}'::jsonb),
      pg_temp.ev('S-OWN-05', 'thread:bp-2244036', '{"mileage_km":285000}'::jsonb),
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":169000}'::jsonb),
      pg_temp.ev('S-OWN-31', 'thread:bf-1442690', '{"mileage_km":158000}'::jsonb))));

select pg_temp.stage('C-048#b', 'bmw', 'var:n63b44o2', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-31', 'thread:bf-1442690', null),
      pg_temp.ev('S-OWN-31', 'thread:bp-1695372', '{"mileage_km":158000}'::jsonb))));

select pg_temp.stage('C-049#a', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-16'))));

select pg_temp.stage('C-049#b', 'bmw', 'var:n63b44o2', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-11'), pg_temp.ev('S-OFF-16'))));

select pg_temp.stage('C-050', 'bmw', 'var:n63b44o2', 'owner_pattern', 'low',
  'Tuning does not change the pressure in the cooling lines, so coolant leaks are not directly linked to a reflash.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-01', 'thread:bp-1618778', '{"mileage_km":64000}'::jsonb))));

select pg_temp.stage('C-051', 'bmw', 'issue:n63_bore_scoring', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-32', 'thread:bp-2013791', '{"mileage_km":87000,"market":"CA"}'::jsonb),
      pg_temp.ev('S-OWN-27', 'thread:bf-1434091', '{"mileage_km":151000,"market":"US"}'::jsonb),
      pg_temp.ev('S-OWN-33', 'thread:d2-750li', '{"mileage_km":68000,"market":"RU"}'::jsonb),
      pg_temp.ev('S-SPEC-19'),
      pg_temp.ev('S-SPEC-20', null, null, 'contradicts',
        'A specialist blog claims scoring appears between 5,000 and 15,000 kilometres without presenting data.'))));

select pg_temp.stage('C-052', 'bmw', 'fam:n63', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-19'))));

select pg_temp.stage('C-053#a', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-16'), pg_temp.ev('S-MKT-06'))));

select pg_temp.stage('C-053#b', 'bmw', 'var:n63b44o2', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":160000}'::jsonb),
      pg_temp.ev('S-SEARCH', null, null, 'contradicts',
...
select pg_temp.stage('C-054', 'bmw', 'var:n63b44o2', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-34', 'thread:bp-1786725', '{"mileage_km":80000}'::jsonb),
      pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-055', 'bmw', 'fam:n63', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    'causal', 'plausible_mechanism',
    'ev', jsonb_build_array(pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-056', 'bmw', 'var:n63b44o2', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      ...
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":169000}'::jsonb),
      pg_temp.ev('S-OWN-31', 'thread:bf-1442690', '{"mileage_km":158000}'::jsonb),
      pg_temp.ev('DOC2', null, null, 'contradicts',
        'The owner document proposed a 100,000 to 150,000 kilometre turbocharger life, which the delta audit rejected.'))));

select pg_temp.stage('C-057', 'bmw', 'issue:n63_spun_bearing', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    'causal', 'supported_cause',
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-21'), pg_temp.ev('S-SPEC-19'))));
...
select pg_temp.stage('C-060', 'bmw', 'maint:n63tu2_oil', 'official_fact', 'high',
...
select pg_temp.stage('C-061', 'bmw', 'maint:n63tu2_oil', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-08'))));

select pg_temp.stage('C-062', 'bmw', 'maint:n63tu2_oil', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-12'), pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-063#a', 'bmw', 'maint:n63tu2_oil', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      ...
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":161000}'::jsonb),
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":169000}'::jsonb),
      pg_temp.ev('S-OWN-25', 'thread:d2-m550', '{"mileage_km":90000}'::jsonb),
      pg_temp.ev('S-OWN-33', 'thread:d2-750li', '{"mileage_km":90000}'::jsonb),
      pg_temp.ev('S-OWN-35', 'thread:bf-1458547', '{"mileage_km":160000}'::jsonb),
      pg_temp.ev('S-OWN-31', 'thread:bf-1442690', '{"mileage_km":158000}'::jsonb))));

select pg_temp.stage('C-063#b', 'bmw', 'maint:n63tu2_oil', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'causal', 'plausible_mechanism',
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-22'), pg_temp.ev('S-SPEC-20'), pg_temp.ev('S-SPEC-23'))));

select pg_temp.stage('C-064', 'bmw', 'maint:n63tu2_plugs', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-OWN-13'), pg_temp.ev('S-MKT-04'))));

select pg_temp.stage('C-065', 'bmw', 'maint:n63tu2_coolant', 'official_fact', 'high',
...
select pg_temp.stage('C-066', 'bmw', 'maint:n63tu2_radiators', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'causal', 'plausible_mechanism',
    'applic', jsonb_build_array(
      pg_temp.p_tag('condition_tag', 'hot_climate', 1),
      pg_temp.p_tag('condition_tag', 'city_dominant', 1)),
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-33', 'thread:d2-750li', '{"mileage_km":90000}'::jsonb),
      pg_temp.ev('S-OWN-35', 'thread:bf-1458547', '{"mileage_km":160000}'::jsonb),
      pg_temp.ev('S-SPEC-20'))));

select pg_temp.stage('C-067', 'bmw', 'state:n63_thermostat_defeat', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    'causal', 'observed_association',
    'applic', jsonb_build_array(
      pg_temp.p_tag('market_operated', 'RU', 1),
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-33', 'thread:d2-750li', '{"mileage_km":90000}'::jsonb),
      pg_temp.ev('S-OWN-25', 'thread:d2-m550', '{"mileage_km":90000}'::jsonb),
      pg_temp.ev('S-OFF-16', null, null, 'contradicts',
        'The official temperature map of 105 to 120 degrees Celsius shows that the high reading is designed behaviour.'))));

select pg_temp.stage('C-068', 'bmw', 'var:n63b44o2', 'calcar_synthesis', 'medium',
...
select pg_temp.stage('C-070', 'bmw', 'var:n63b44o2', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-TUN-01'))));

select pg_temp.stage('C-071', 'bmw', 'var:n63b44o2', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-TUN-02'))));

select pg_temp.stage('C-072', 'bmw', 'var:zf8hp75', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-TUN-03'), pg_temp.ev('S-SEARCH'))));

-- ---------- B6. Коробка ----------

select pg_temp.stage('C-080', 'bmw', 'maint:zf8hp75_atf', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-13'), pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-081', 'bmw', 'maint:zf8hp75_atf', 'owner_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":161000}'::jsonb),
      pg_temp.ev('S-OWN-14', 'thread:bp-1971470', '{"mileage_km":130000}'::jsonb))));

select pg_temp.stage('C-082', 'bmw', 'fam:zf8hp', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-13'))));

select pg_temp.stage('C-083', 'bmw', 'var:zf8hp75', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-090', 'bmw', 'issue:g30_xdrive_shudder', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-09'), pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-091', 'bmw', 'maint:atc13_fluid', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-09'))));

select pg_temp.stage('C-092', 'bmw', 'issue:g30_flex_disc', 'owner_pattern', 'medium',
  'The flexible propshaft coupling is replaced between 80,000 and 170,000 kilometres.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":169000}'::jsonb),
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":77000}'::jsonb))));

select pg_temp.stage('C-093', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-14'),
      pg_temp.ev('S-OWN-15', 'thread:bp-snow'),
      pg_temp.ev('S-OWN-15', 'thread:bf-winter-tyres'))));

-- ---------- B8. Шасі ----------

select pg_temp.stage('C-100', 'bmw', 'issue:g30_tension_strut', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    'applic', jsonb_build_array(pg_temp.p_ref('generation', 'gen:g30')),
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-14'),
      pg_temp.ev('S-OWN-16', 'thread:bp-1876339', '{"mileage_km":65000}'::jsonb))));

select pg_temp.stage('C-101', 'bmw', 'issue:m550i_damper_leak', 'known_issue', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(pg_temp.ev('S-AGG-02'))));

select pg_temp.stage('C-102', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-17', 'thread:bp-1646815'),
      pg_temp.ev('S-OWN-17', 'thread:bf-ias'),
      pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-103', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"age_years":3}'::jsonb),
      pg_temp.ev('S-OWN-15', 'thread:bf-runflat', '{"age_years":3}'::jsonb))));

select pg_temp.stage('C-104', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'low',
...
select pg_temp.stage('C-110', 'bmw', 'issue:g30_ac_evaporator', 'known_issue', 'high',
  ...
  jsonb_build_object(
    ...
    'applic', jsonb_build_array(pg_temp.p_ref('generation', 'gen:g30')),
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-15'),
      pg_temp.ev('S-OWN-18', 'thread:bp-2173396', '{"mileage_km":85000}'::jsonb),
      pg_temp.ev('S-OWN-06', 'thread:bp-2193771', '{"mileage_km":169000}'::jsonb))));

select pg_temp.stage('C-111', 'bmw', 'issue:g30_led_drl', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-19', 'thread:bp-drl-failed'),
      pg_temp.ev('S-OWN-19', 'thread:bp-drl-yellow'),
      pg_temp.ev('S-MKT-05'))));

select pg_temp.stage('C-112', 'bmw', 'issue:g30_adaptive_headlight', 'specialist_practice', 'medium',
  'Moisture inside an adaptive headlight kills the module and produces the adaptive headlight malfunction message.',
  jsonb_build_object(
    'causal', 'supported_cause',
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-16'))));

select pg_temp.stage('C-113', 'bmw', 'issue:g30_battery_drain', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-20', 'thread:bp-1914014', '{"age_years":4}'::jsonb),
      pg_temp.ev('S-SPEC-17'))));

select pg_temp.stage('C-114', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'low',
...
select pg_temp.stage('C-115', 'bmw', 'vmy:m550i_us_2018', 'official_fact', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-01'), pg_temp.ev('S-OFF-02'), pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-116', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  'The exhaust note is widely considered muted, the active sound design is synthetic, and switching it off requires coding.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-21', 'thread:bp-exhaust-sounds'),
      pg_temp.ev('S-OWN-21', 'thread:bf-exhaust-great'),
      pg_temp.ev('S-REV-01'),
      pg_temp.ev('DOC2', null, null, 'contradicts',
...
select pg_temp.stage('C-120', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-22', 'thread:bp-1826385', '{"mileage_km":50000}'::jsonb),
      pg_temp.ev('S-OWN-03', 'thread:bp-2152583', '{"mileage_km":177000}'::jsonb),
      pg_temp.ev('S-OWN-04', 'thread:bp-1950718', '{"mileage_km":161000}'::jsonb))));

select pg_temp.stage('C-121', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-23', 'thread:bp-2116863', '{"mileage_km":100000}'::jsonb))));

select pg_temp.stage('C-122', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-123#a', 'bmw', 'issue:b58_oil_filter_housing', 'known_issue', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-18'), pg_temp.ev('S-SEARCH'))));

select pg_temp.stage('C-123#b', 'bmw', 'var:b58b30', 'official_fact', 'medium',
...
select pg_temp.stage('C-124', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  'A tuned six cylinder car does not become this car and the reverse is equally untrue: the character is different.',
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-23', 'thread:bp-2116863', '{"mileage_km":100000}'::jsonb))));

select pg_temp.stage('C-125#a', 'bmw', 'ver:m550i_g30', 'owner_pattern', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-24', 'thread:bp-lci-m550-v-m5'),
      pg_temp.ev('S-OWN-24', 'thread:bp-f90-m5-vs-m550'),
      pg_temp.ev('S-OWN-36', 'thread:bp-1936787'),
      pg_temp.ev('S-REV-03'))));

select pg_temp.stage('C-125#b', 'bmw', 'ver:m550i_g30', 'calcar_synthesis', 'medium',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-REV-03'), pg_temp.ev('S-OWN-36'), pg_temp.ev('S-OFF-14'))));

select pg_temp.stage('C-126', 'bmw', 'var:n63b44o2', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-12', 'thread:bp-1776989'))));

select pg_temp.stage('C-127#a', 'bmw', 'var:s63b44t4', 'official_fact', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OFF-14'), pg_temp.ev('S-SPEC-24'), pg_temp.ev('S-OWN-36'))));

select pg_temp.stage('C-127#b', 'bmw', 'var:n63b44o2', 'specialist_practice', 'medium',
  'This car is not a detuned M5: a reflash adds none of the M division lubrication, cooling or exhaust manifold hardware.',
  jsonb_build_object(
    'causal', 'supported_cause',
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-24'), pg_temp.ev('S-OFF-14'))));

-- ---------- B11. Стан перебраного мотора ----------

select pg_temp.stage('C-130#a', 'bmw', 'var:n63b44o2', 'official_fact', 'high',
  'The Alusil cylinders of this engine cannot be bored to an oversize.',
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-OFF-16'))));

select pg_temp.stage('C-130#b', 'bmw', 'var:n63b44o2', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-19'),
      pg_temp.ev('S-OWN-32', 'thread:bp-2013791', '{"mileage_km":87000}'::jsonb),
      pg_temp.ev('S-OWN-37', 'thread:bmwclub-926858'),
      pg_temp.ev('S-SPEC-25'))));

select pg_temp.stage('C-131', 'bmw', 'var:n63b44o2', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-26'), pg_temp.ev('S-SPEC-25'),
      pg_temp.ev('S-OWN-37', 'thread:bmwclub-926858'))));

select pg_temp.stage('C-132', 'bmw', 'issue:sleeve_liner_risk', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    'causal', 'supported_cause',
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-27'), pg_temp.ev('S-SPEC-19'),
      pg_temp.ev('S-OWN-37', 'thread:bmwclub-1501368'))));

select pg_temp.stage('C-133', 'bmw', 'state:n63_sleeved', 'owner_pattern', 'low',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-37', 'thread:bmwclub-926858', '{"mileage_km":50000}'::jsonb),
      pg_temp.ev('S-OWN-37', 'thread:bmwclub-1501368', '{"mileage_km":140000}'::jsonb),
      pg_temp.ev('S-SPEC-26'), pg_temp.ev('S-SPEC-28'))));

select pg_temp.stage('C-134', 'bmw', 'state:n63_sleeved', 'calcar_synthesis', 'medium',
...
select pg_temp.stage('C-135', 'bmw', 'state:n63_sleeved', 'calcar_synthesis', 'medium',
...
select pg_temp.stage('C-140#a', 'bmw', 'chk:n63_borescope', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-SPEC-19'),
      pg_temp.ev('S-OWN-32', 'thread:bp-2013791', '{"mileage_km":87000}'::jsonb),
      pg_temp.ev('S-OWN-27', 'thread:bf-1434091', '{"mileage_km":151000}'::jsonb),
      pg_temp.ev('S-OWN-38', 'thread:bp-2067402'))));

select pg_temp.stage('C-140#b', 'bmw', 'chk:n63_borescope', 'calcar_synthesis', 'high',
  ...
  jsonb_build_object(
    'ev', jsonb_build_array(pg_temp.ev('S-SPEC-19'), pg_temp.ev('S-OWN-32'))));

select pg_temp.stage('C-141', 'bmw', 'chk:n63_compression', 'specialist_practice', 'medium',
  ...
  jsonb_build_object(
    ...
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-39', 'thread:bf-1324037', '{"mileage_km":93000}'::jsonb))));

select pg_temp.stage('C-142', 'bmw', 'chk:n63_leak_down', 'specialist_practice', 'medium',
...
select pg_temp.stage('C-143', 'bmw', 'chk:g30_ista_scan', 'specialist_practice', 'high',
  ...
  jsonb_build_object(
    'causal', 'supported_cause',
    'ev', jsonb_build_array(
      pg_temp.ev('S-OWN-02', 'thread:bp-2074062'),
      pg_temp.ev('S-OWN-32', 'thread:bp-2013791', '{"mileage_km":87000}'::jsonb))));

select pg_temp.stage('C-144#a', 'bmw', 'chk:n63_oil_analysis', 'owner_pattern', 'medium',
...
select pg_temp.stage('C-144#b', 'bmw', 'chk:n63_oil_analysis', 'specialist_practice', 'medium',
...
select pg_temp.stage('C-145', 'bmw', 'chk:n63_turbo_check', 'specialist_practice', 'medium',
...
select pg_temp.stage('C-146', 'bmw', 'var:n63b44o2', 'calcar_synthesis', 'high',
